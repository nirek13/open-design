...
// Route tests still speak as a machine owner. Production and `tools-dev`
// require Clerk unless this is set; identity.test.ts covers that default.
process.env.OD_AUTH_MODE ??= 'local-owner';
