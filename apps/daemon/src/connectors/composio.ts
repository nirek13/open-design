...
const FEATURED_COMPOSIO_CATALOG: ConnectorCatalogDefinition[] = [
  {
    ...
    provider: 'composio',
    category: 'Developer',
    description: 'Work with GitHub repositories, issues, pull requests, and commits.',
    ...
    tools: [
      ...
      defineConnectorTool({
        ...
        inputSchemaJson: { type: 'object', properties: { owner: { type: 'string' }, repo: { type: 'string' }, state: { type: 'string' } }, required: ['owner', 'repo'], additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['pulls:read'],
      }),
      defineConnectorTool({
        name: 'github.github_list_commits',
        providerToolId: 'GITHUB_LIST_COMMITS',
        title: 'List commits',
        description: 'List recent commits in a repository.',
        inputSchemaJson: { type: 'object', properties: { owner: { type: 'string' }, repo: { type: 'string' } }, required: ['owner', 'repo'], additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['read'],
      }),
    ],
  ...
  },
  {
    ...
    description: 'Search Notion pages and databases, including dated rows for the calendar.',
    ...
    tools: [
      ...
      defineConnectorTool({
        ...
        description: 'Query Notion database rows, including date properties used as calendar events.',
        inputSchemaJson: { type: 'object', properties: { database_id: { type: 'string' }, page_size: { type: 'integer' } }, required: ['database_id'], additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['databases:read'],
      }),
      defineConnectorTool({
        name: 'notion.notion_get_page',
        providerToolId: 'NOTION_GET_PAGE',
        title: 'Get page',
        description: 'Read a Notion page.',
        inputSchemaJson: { type: 'object', properties: { page_id: { type: 'string' } }, required: ['page_id'], additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['read'],
      }),
    ],
    ...
    featuredToolNames: ['notion.notion_search', 'notion.notion_fetch_database', 'notion.notion_query_database'],
    minimumApproval: 'auto',
    toolCount: 48,
  },
  {
  ...
  },
  {
    ...
    provider: 'composio',
    category: 'Email',
    description: 'Read, send, and manage Gmail from the in-app mail client.',
    providerConnectorId: 'GMAIL',
    authentication: 'composio',
    tools: [
      defineConnectorTool({
        name: 'gmail.gmail_search_emails',
        providerToolId: 'GMAIL_SEARCH_EMAILS',
        title: 'Search email',
      ...
      defineConnectorTool({
        name: 'gmail.gmail_fetch_emails',
        providerToolId: 'GMAIL_FETCH_EMAILS',
        title: 'Fetch recent mail',
        description: 'Read recent Gmail messages.',
        inputSchemaJson: { type: 'object', properties: { max_results: { type: 'number' } }, additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['gmail.readonly'],
      }),
      defineConnectorTool({
        name: 'gmail.gmail_list_labels',
        providerToolId: 'GMAIL_LIST_LABELS',
        title: 'List labels',
      ...
      defineConnectorTool({
        name: 'gmail.gmail_fetch_thread',
        providerToolId: 'GMAIL_FETCH_MESSAGE_BY_THREAD_ID',
        title: 'Read thread',
        description: 'Read every message in a Gmail thread.',
        inputSchemaJson: { type: 'object', properties: { thread_id: { type: 'string' } }, required: ['thread_id'], additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['gmail.readonly'],
      }),
      defineConnectorTool({
        name: 'gmail.gmail_send_email',
        providerToolId: 'GMAIL_SEND_EMAIL',
        title: 'Send email',
      ...
      defineConnectorTool({
        name: 'gmail.gmail_reply_to_thread',
        providerToolId: 'GMAIL_REPLY_TO_THREAD',
        title: 'Reply',
      ...
      defineConnectorTool({
        name: 'gmail.gmail_add_label',
        providerToolId: 'GMAIL_ADD_LABEL_TO_EMAIL',
        title: 'Modify labels',
        description: 'Star, archive, or mark a Gmail message read or unread.',
        inputSchemaJson: {
          type: 'object',
          properties: {
      ...
      defineConnectorTool({
        name: 'gmail.gmail_move_to_trash',
        providerToolId: 'GMAIL_MOVE_TO_TRASH',
        title: 'Move to trash',
        description: 'Move a Gmail message to trash.',
        inputSchemaJson: { type: 'object', properties: { message_id: { type: 'string' } }, required: ['message_id'], additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['gmail.modify'],
      }),
    ],
    allowedToolNames: [
      ...
      'gmail.gmail_fetch_thread',
      'gmail.gmail_send_email',
      'gmail.gmail_reply_to_thread',
  ...
  },
  {
    ...
    description: 'Read channels, search messages, and send to Slack from the in-app client.',
    providerConnectorId: 'SLACK',
    authentication: 'composio',
    tools: [
      defineConnectorTool({
        name: 'slack.slack_list_channels',
        providerToolId: 'SLACK_LIST_ALL_CHANNELS',
        title: 'List channels',
        description: 'List Slack channels in the connected workspace.',
        inputSchemaJson: { type: 'object', properties: { types: { type: 'string' }, limit: { type: 'number' } }, additionalProperties: true },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['channels:read', 'groups:read'],
      }),
      defineConnectorTool({
        name: 'slack.slack_fetch_conversation_history',
        providerToolId: 'SLACK_FETCH_CONVERSATION_HISTORY',
        title: 'Channel history',
        description: 'Read recent messages in a Slack channel or DM.',
        inputSchemaJson: { type: 'object', properties: { channel: { type: 'string' }, limit: { type: 'number' } }, required: ['channel'], additionalProperties: true },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['channels:history', 'groups:history', 'im:history'],
      }),
      defineConnectorTool({
        name: 'slack.slack_search_messages',
        providerToolId: 'SLACK_SEARCH_MESSAGES',
        title: 'Search messages',
        description: 'Search Slack messages the connected user can see.',
        inputSchemaJson: { type: 'object', properties: { query: { type: 'string' } }, required: ['query'], additionalProperties: true },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['search:read'],
      }),
      defineConnectorTool({
        name: 'slack.slack_list_users',
        providerToolId: 'SLACK_LIST_ALL_USERS',
        title: 'List users',
        description: 'List people in the Slack workspace.',
        inputSchemaJson: { type: 'object', properties: { limit: { type: 'number' } }, additionalProperties: true },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['users:read'],
      }),
      defineConnectorTool({
        name: 'slack.slack_send_message',
        providerToolId: 'SLACK_SEND_MESSAGE',
        title: 'Send message',
  ...
  },
  {
    ...
    tools: [
      defineConnectorTool({
        name: 'googlecalendar.googlecalendar_list_events',
        providerToolId: 'GOOGLECALENDAR_EVENTS_LIST_ALL_CALENDARS',
        title: 'List events',
        description: 'List events on the primary Google Calendar.',
        inputSchemaJson: { type: 'object', properties: { timeMin: { type: 'string' }, timeMax: { type: 'string' } }, additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['calendar.readonly'],
      }),
      defineConnectorTool({
        name: 'googlecalendar.googlecalendar_create_event',
        providerToolId: 'GOOGLECALENDAR_CREATE_EVENT',
        title: 'Create event',
        description: 'Create an event on the primary Google Calendar.',
        inputSchemaJson: { type: 'object', properties: { summary: { type: 'string' }, start_datetime: { type: 'string' }, end_datetime: { type: 'string' } }, required: ['summary'], additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['calendar.events'],
      }),
    ],
    allowedToolNames: ['googlecalendar.googlecalendar_list_events', 'googlecalendar.googlecalendar_create_event'],
    featuredToolNames: ['googlecalendar.googlecalendar_list_events', 'googlecalendar.googlecalendar_create_event'],
    minimumApproval: 'auto',
    toolCount: 2,
  },
  {
    ...
    providerConnectorId: 'GOOGLESHEETS',
    authentication: 'composio',
    tools: [
      defineConnectorTool({
        name: 'googlesheets.googlesheets_get_spreadsheet',
        providerToolId: 'GOOGLESHEETS_GET_SPREADSHEET',
        title: 'Get spreadsheet',
        description: 'Read a Google Sheet by id.',
        inputSchemaJson: { type: 'object', properties: { spreadsheet_id: { type: 'string' } }, required: ['spreadsheet_id'], additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['spreadsheets.readonly'],
      }),
    ],
    allowedToolNames: ['googlesheets.googlesheets_get_spreadsheet'],
    featuredToolNames: ['googlesheets.googlesheets_get_spreadsheet'],
    minimumApproval: 'auto',
    toolCount: 1,
  },
  {
    ...
    providerConnectorId: 'OUTLOOK',
    authentication: 'composio',
    tools: [
      defineConnectorTool({
        name: 'outlook.outlook_list_messages',
        providerToolId: 'OUTLOOK_LIST_MESSAGES',
        title: 'List mail',
        description: 'List recent Outlook messages.',
        inputSchemaJson: { type: 'object', properties: { top: { type: 'number' } }, additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['mail.read'],
      }),
    ],
    allowedToolNames: ['outlook.outlook_list_messages'],
    featuredToolNames: ['outlook.outlook_list_messages'],
    minimumApproval: 'auto',
    toolCount: 1,
  },
  {
    ...
    providerConnectorId: 'HUBSPOT',
    authentication: 'composio',
    tools: [
      defineConnectorTool({
        name: 'hubspot.hubspot_list_contacts',
        providerToolId: 'HUBSPOT_LIST_CONTACTS',
        title: 'List contacts',
        description: 'List HubSpot contacts.',
        inputSchemaJson: { type: 'object', properties: { limit: { type: 'number' } }, additionalProperties: false },
        outputSchemaJson: { type: 'object', additionalProperties: true },
        requiredScopes: ['crm.objects.contacts.read'],
      }),
      defineConnectorTool({
        name: 'hubspot.hubspot_list_deals',
        providerToolId: 'HUBSPOT_LIST_DEALS',
        title: 'List deals',
    ...
    allowedToolNames: ['hubspot.hubspot_list_contacts', 'hubspot.hubspot_list_deals'],
    featuredToolNames: ['hubspot.hubspot_list_contacts', 'hubspot.hubspot_list_deals'],
    minimumApproval: 'auto',
    toolCount: 2,
  },
];
