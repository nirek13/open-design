...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'Substrate artifact';
...
- Keep generated product UI free of Substrate chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or Substrate chrome in the production UI.
