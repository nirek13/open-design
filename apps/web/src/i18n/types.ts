...
export interface Dict {
  ...
  'settings.onboardingDefaultKeyTitle': string;
  'settings.onboardingDefaultKeyBody': string;
  'settings.onboardingDefaultKeyAction': string;
  'settings.onboardingDefaultKeyReady': string;
  'settings.onboardingOwnKeyChoice': string;
  'settings.onboardingGateTooltipDefaultKey': string;
  'settings.onboardingDefaultKeyFailed': string;
  ...
  'settings.toolsTitle': string;
  'settings.toolsHint': string;
  'settings.toolsNavSub': string;
  'settings.toolsInternalHeading': string;
  'settings.toolsExternalHeading': string;
  'settings.toolsMcpHeading': string;
  'settings.toolsEnableAll': string;
  'settings.toolsDisableAll': string;
  'settings.onboardingToolsTitle': string;
  'settings.onboardingToolsBody': string;
  'settings.onboardingStepTools': string;
  'automations.toolsLabel': string;
  'automations.toolsHint': string;
  'automations.toolsCount': string;
  'tools.toggleAria': string;
  ...
  'settings.connectOpen': string;
  'settings.connectOpenHint': string;
  ...
  // Sidebar + Places catalog
  'entry.navExpand': string;
  'entry.navCollapse': string;
  'entry.navAtlas': string;
  'entry.navAtlasHint': string;
  'entry.navOpenAtlas': string;
  'entry.navCloseAtlas': string;
  'entry.navIslandWork': string;
  'entry.navIslandMake': string;
  'entry.navIslandConnect': string;
  'entry.navIslandMore': string;
  ...
  'entry.navDatabase': string;
  'entry.navLibrary': string;
  'entry.navApps': string;
  'apps.activity': string;
  'apps.noActivity': string;
  'apps.open': string;
  'apps.edit': string;
  'apps.close': string;
  'apps.failedToRun': string;
  'apps.run': string;
  'apps.permissions': string;
  'crm.tab.pipeline': string;
  'crm.tab.deals': string;
  'crm.tab.contacts': string;
  'crm.tab.activities': string;
  'crm.tab.customers': string;
  'crm.tab.receivables': string;
  'crm.singular.pipeline': string;
  'crm.singular.deals': string;
  'crm.singular.contacts': string;
  'crm.singular.activities': string;
  'crm.singular.customers': string;
  'crm.newOf': string;
  'record.history': string;
  'record.showHistory': string;
  'record.current': string;
  'record.restore': string;
  'record.restored': string;
  'record.op.create': string;
  'record.op.update': string;
  'record.op.delete': string;
  'record.op.restore': string;
  'entry.navInventory': string;
  'entry.navJobs': string;
  'record.loading': string;
  'record.close': string;
  'record.notes': string;
  'record.fields': string;
  'record.linked': string;
  'record.deleted': string;
  'record.post': string;
  'record.posted': string;
  'record.postSkipped': string;
  'record.convertTo': string;
  'record.converted': string;
  'record.andMore': string;
  'inventory.title': string;
  'inventory.lead': string;
  'inventory.noOrg': string;
  'inventory.refresh': string;
  'inventory.levels': string;
  'inventory.sku': string;
  'inventory.product': string;
  'inventory.onHand': string;
  'inventory.reorderAt': string;
  'inventory.unitCost': string;
  'inventory.value': string;
  'inventory.status': string;
  'inventory.reorder': string;
  'inventory.ok': string;
  'inventory.totalValue': string;
  'inventory.needsReorder': string;
  'inventory.acrossProducts': string;
  'inventory.noProducts': string;
  'inventory.noProductsBody': string;
  'inventory.setUpTitle': string;
  'inventory.setUpBody': string;
  'inventory.setUpAction': string;
  'inventory.installing': string;
  'projects.title': string;
  'projects.lead': string;
  'projects.noOrg': string;
  'projects.refresh': string;
  'projects.all': string;
  'projects.project': string;
  'projects.customer': string;
  'projects.status': string;
  'projects.tasks': string;
  'projects.hours': string;
  'projects.billable': string;
  'projects.budget': string;
  'projects.remaining': string;
  'projects.totalHours': string;
  'projects.totalBillable': string;
  'projects.acrossProjects': string;
  'projects.none': string;
  'projects.noneBody': string;
  'projects.setUpTitle': string;
  'projects.setUpBody': string;
  'projects.setUpAction': string;
  'projects.installing': string;
  'entry.navTables': string;
  'tables.title': string;
  'tables.lead': string;
  'tables.noOrg': string;
  'tables.tables': string;
  'tables.noTables': string;
  'tables.noTablesBody': string;
  'tables.display': string;
  'tables.displayCards': string;
  'tables.displayTable': string;
  'tables.publicWrite': string;
  'tables.publicWriteHint': string;
  'grid.addRow': string;
  'grid.addColumn': string;
  'grid.openRecord': string;
  'grid.computed': string;
  'grid.empty': string;
  'views.label': string;
  'views.newName': string;
  'views.groupBy': string;
  'views.noGrouping': string;
  'views.kind.table': string;
  'views.kind.board': string;
  'views.kind.gallery': string;
  'views.kind.calendar': string;
  'views.kind.list': string;
  'command.placeholder': string;
  'command.apply': string;
  'command.show': string;
  'command.working': string;
  'command.confidence': string;
  'command.tooUnsure': string;
  'command.ignored': string;
  'command.tryLabel': string;
  'approvals.origin_agent': string;
  'approvals.origin_user': string;
  'approvals.status_pending': string;
  'approvals.status_approved': string;
  'approvals.status_rejected': string;
  'approvals.status_applied': string;
  'approvals.status_undone': string;
  'approvals.status_failed': string;
  'books.status_draft': string;
  'books.status_posted': string;
  'books.status_reversed': string;
  'books.type_asset': string;
  'books.type_liability': string;
  'books.type_equity': string;
  'books.type_revenue': string;
  'books.type_expense': string;
  'entry.navTemplates': string;
  'templates.title': string;
  'templates.lead': string;
  'templates.noOrg': string;
  'templates.refresh': string;
  'templates.installed': string;
  'templates.notInstalled': string;
  'templates.partial': string;
  'templates.add': string;
  'templates.alreadyAdded': string;
  'templates.installing': string;
  'templates.adminOnly': string;
  'templates.requires': string;
  'templates.installedTables': string;
  'templates.nothingNew': string;
  'templates.safetyNote': string;

  // The business surfaces: workspace home, books, approvals, and the
  // CRM / purchasing / team-chat packs.
  'entry.navWorkspace': string;
  'entry.navErp': string;
  'erp.shell.subtitle': string;
  'erp.module.hub': string;
  'erp.module.approvals': string;
  'erp.module.books': string;
  'erp.module.crm': string;
  'erp.module.purchasing': string;
  'erp.module.inventory': string;
  'erp.module.jobs': string;
  'erp.module.tables': string;
  'erp.module.templates': string;
  'erp.module.connections': string;
  'erp.module.netsuite': string;
  'erp.connections.title': string;
  'erp.connections.body': string;
  'erp.connections.browseAll': string;
  'erp.connections.connect': string;
  'erp.connections.connected': string;
  'erp.connections.connecting': string;
  'erp.connections.loading': string;
  'erp.connections.group.mail': string;
  'erp.connections.group.calendar': string;
  'erp.connections.group.docs': string;
  'erp.connections.group.chat': string;
  'erp.connections.group.crm': string;
  'erp.connections.group.finance': string;
  'erp.connections.group.work': string;
  'erp.connections.connectedCount': string;
  'erp.netsuite.title': string;
  'erp.netsuite.body': string;
  'erp.netsuite.connect': string;
  'erp.netsuite.bullet1': string;
  'erp.netsuite.bullet2': string;
  'erp.netsuite.bullet3': string;
  'entry.navApprovals': string;
  'entry.navBooks': string;
  'entry.navCrm': string;
  'entry.navPurchasing': string;
  'entry.navTeam': string;
  'workspace.title': string;
  'workspace.subtitle': string;
  'workspace.searchPlaceholder': string;
  'workspace.clearSearch': string;
  'workspace.noResults': string;
  'workspace.noResultsHint': string;
  'workspace.acrossRecords': string;
  'workspace.createTitle': string;
  'workspace.newOf': string;
  'workspace.newOfHint': string;
  'workspace.buildTool': string;
  'workspace.buildToolHint': string;
  'workspace.magicImport': string;
  'workspace.magicImportHint': string;
  'workspace.dropToImport': string;
  'workspace.greetingMorning': string;
  'workspace.greetingAfternoon': string;
  'workspace.greetingEvening': string;
  'workspace.greetingNamed': string;
  'workspace.uploadAssets': string;
  'workspace.needsYou': string;
  'workspace.approve': string;
  'workspace.reject': string;
  'workspace.pinned': string;
  'workspace.recent': string;
  'workspace.noRecent': string;
  'workspace.noRecentHint': string;
  'workspace.yourTable': string;
  'workspace.openDatabase': string;
  'workspace.dataSources': string;
  'workspace.openTable': string;
  'workspace.setUpTitle': string;
  'workspace.setUpBody': string;
  'workspace.setUpAction': string;
  'workspace.settingUp': string;
  'workspace.askPlaceholder': string;
  'workspace.askSubmit': string;
  'workspace.askHint': string;
  'workspace.askApplying': string;
  'workspace.heroLead': string;
  'workspace.startersLabel': string;
  'workspace.starterSiteLabel': string;
  'workspace.starterSitePrompt': string;
  'workspace.starterDeckLabel': string;
  'workspace.starterDeckPrompt': string;
  'workspace.starterTableLabel': string;
  'workspace.starterTablePrompt': string;
  'workspace.starterDocLabel': string;
  'workspace.starterDocPrompt': string;
  'workspace.minutesAgo': string;
  'workspace.hoursAgo': string;
  'workspace.daysAgo': string;
  ...
  'editor.yes': string;
  'editor.no': string;
  'editor.badNumber': string;
  'editor.badJson': string;
  'editor.postToBooks': string;
  'editor.postedEntry': string;
  'editor.postSkipped': string;
  'builder.title': string;
  'builder.close': string;
  'builder.back': string;
  'builder.describeName': string;
  'builder.describeHint': string;
  'builder.describeBody': string;
  'builder.describePlaceholder': string;
  'builder.buildIt': string;
  'builder.existingName': string;
  'builder.existingHint': string;
  'builder.existingBody': string;
  'builder.existingEmpty': string;
  'builder.existingContinue': string;
  'builder.existingBuildPrompt': string;
  'builder.existingBuildPlaceholder': string;
  'builder.existingBuildSubmit': string;
  'builder.importName': string;
  'builder.importHint': string;
  'builder.importBody': string;
  'builder.importAction': string;
  'builder.importCommit': string;
  'builder.importUrlPlaceholder': string;
  'builder.importUrlAction': string;
  'builder.importUrlHint': string;
  'builder.importing': string;
  'builder.appending': string;
  'builder.planSummary': string;
  'builder.skippedRows': string;
  'builder.previewTitle': string;
  'builder.sourceLink': string;
  'builder.previewMore': string;
  'builder.column': string;
  'builder.readAs': string;
  'builder.why': string;
  'builder.defineName': string;
  'builder.defineHint': string;
  'builder.defineBody': string;
  'builder.tableNamePlaceholder': string;
  'builder.fieldName': string;
  'builder.fieldType': string;
  'builder.required': string;
  'builder.addField': string;
  'builder.createTable': string;
  'builder.wikiName': string;
  'builder.wikiHint': string;
  'builder.wikiBody': string;
  'builder.wikiPlaceholder': string;
  'builder.nextTitle': string;
  'builder.nextHint': string;
  'builder.nextView': string;
  'builder.nextBuild': string;
  'builder.nextBuildHint': string;
  'builder.nextBuildPrompt': string;
  'builder.nextBuildPlaceholder': string;
  'builder.nextBuildSubmit': string;
  'builder.nextRefresh': string;
  'builder.nextRefreshHint': string;
  'builder.refreshHourly': string;
  'builder.refreshDaily': string;
  'builder.refreshWeekdays': string;
  'builder.refreshing': string;
  'builder.refreshScheduled': string;
  'builder.buildingApp': string;
  'builder.uniqueKey': string;
  'approvals.title': string;
  'approvals.lead': string;
  'approvals.tabPending': string;
  'approvals.tabApplied': string;
  'approvals.tabAll': string;
  'approvals.approve': string;
  'approvals.reject': string;
  'approvals.undo': string;
  'approvals.working': string;
  'approvals.undoNote': string;
  'approvals.emptyPending': string;
  'approvals.emptyPendingBody': string;
  'approvals.emptyOther': string;
  'books.title': string;
  'books.lead': string;
  'books.tabBalance': string;
  'books.tabJournal': string;
  'books.tabAccounts': string;
  'books.tabPeriods': string;
  'books.asOf': string;
  'books.currency': string;
  'books.code': string;
  'books.account': string;
  'books.type': string;
  'books.debit': string;
  'books.credit': string;
  'books.amount': string;
  'books.totalDebits': string;
  'books.totalCredits': string;
  'books.balanced': string;
  'books.unbalancedWarning': string;
  'books.date': string;
  'books.memo': string;
  'books.status': string;
  'books.entryNumber': string;
  'books.entryTitle': string;
  'books.journalHint': string;
  'books.immutableHint': string;
  'books.reverse': string;
  'books.reversing': string;
  'books.reversalMemo': string;
  'books.isReversal': string;
  'books.wasReversed': string;
  'books.statusReversed': string;
  'books.draftShort': string;
  'books.noEntriesTitle': string;
  'books.noEntriesBody': string;
  'books.noAccounts': string;
  'books.noAccountsBody': string;
  'books.period': string;
  'books.from': string;
  'books.to': string;
  'books.open': string;
  'books.closed': string;
  'books.close': string;
  'books.closeAction': string;
  'books.closing': string;
  'books.closeTitle': string;
  'books.closeBody': string;
  'books.noPeriods': string;
  'books.noPeriodsBody': string;
  'books.yes': string;
  'books.no': string;
  'apps.allOrganizations': string;
  'apps.filterByOrg': string;
  'apps.countShown': string;
  'apps.subtitleAcrossOrgs': string;
  'apps.emptyBody': string;
  'crm.title': string;
  'crm.lead': string;
  'crm.noOrg': string;
  'crm.board': string;
  'crm.refresh': string;
  'crm.openValue': string;
  'crm.openValueDetail': string;
  'crm.weightedValue': string;
  'crm.weightedValueDetail': string;
  'crm.wonValue': string;
  'crm.lostValue': string;
  'crm.weightedShort': string;
  'crm.emptyStage': string;
  'crm.moveLabel': string;
  'crm.toQuote': string;
  'crm.quoteDrafted': string;
  'crm.setUpTitle': string;
  'crm.setUpBody': string;
  'crm.setUpAction': string;
  'crm.installing': string;
  'crm.installed': string;
  'crm.stage.new': string;
  'crm.stage.qualified': string;
  'crm.stage.proposal': string;
  'crm.stage.negotiation': string;
  'crm.stage.won': string;
  'crm.stage.lost': string;
  'crm.receivables': string;
  'crm.invoice': string;
  'crm.customerCol': string;
  'crm.issued': string;
  'crm.due': string;
  'crm.total': string;
  'crm.paid': string;
  'crm.outstanding': string;
  'crm.age': string;
  'crm.overdueDays': string;
  'crm.notDue': string;
  'crm.totalOutstanding': string;
  'crm.totalOverdue': string;
  'crm.acrossInvoices': string;
  'crm.nothingOwed': string;
  'crm.nothingOwedBody': string;
  'purchasing.title': string;
  'purchasing.lead': string;
  'purchasing.noOrg': string;
  'purchasing.refresh': string;
  'purchasing.payables': string;
  'purchasing.bill': string;
  'purchasing.vendor': string;
  'purchasing.issued': string;
  'purchasing.due': string;
  'purchasing.total': string;
  'purchasing.paid': string;
  'purchasing.outstanding': string;
  'purchasing.age': string;
  'purchasing.overdueDays': string;
  'purchasing.notDue': string;
  'purchasing.totalOutstanding': string;
  'purchasing.totalOverdue': string;
  'purchasing.acrossBills': string;
  'purchasing.nothingOwed': string;
  'purchasing.nothingOwedBody': string;
  'purchasing.setUpTitle': string;
  'purchasing.setUpBody': string;
  'purchasing.setUpAction': string;
  'purchasing.installing': string;
  'team.title': string;
  'team.lead': string;
  'team.noOrg': string;
  'team.channels': string;
  'team.newChannel': string;
  'team.create': string;
  'team.channelNamePlaceholder': string;
  'team.join': string;
  'team.private': string;
  'team.send': string;
  'team.messagePlaceholder': string;
  'team.noMessages': string;
  'team.someone': string;
  'team.me': string;
  'team.system': string;
  'team.edited': string;
  'team.replyCount': string;
  'team.setUpTitle': string;
  'team.setUpBody': string;
  'team.setUpAction': string;
  'team.settingUp': string;
  'team.save': string;
  'team.cancel': string;
  'team.addReaction': string;
  'team.replyInThread': string;
  'team.edit': string;
  'team.delete': string;
  'team.workspace': string;
  'team.searchPlaceholder': string;
  'team.search': string;
  'team.directMessages': string;
  'team.newDm': string;
  'team.noPeople': string;
  'team.openDm': string;
  'team.invite': string;
  'team.leave': string;
  'team.noSelection': string;
  'team.noSelectionBody': string;
  'team.emptySearch': string;
  'team.sending': string;
  'team.thread': string;
  'team.closeThread': string;
  'team.attachFile': string;
  ...
  'team.browseEmpty': string;
  'team.about': string;
  'team.members': string;
  'team.files': string;
  'team.pins': string;
  'team.purpose': string;
  'team.purposePlaceholder': string;
  'team.topicPlaceholder': string;
  'team.setTopic': string;
  'team.setPurpose': string;
  'team.star': string;
  'team.unstar': string;
  'team.mute': string;
  'team.unmute': string;
  'team.notifyAll': string;
  'team.notifyMentions': string;
  'team.notifyNothing': string;
  'team.pin': string;
  'team.unpin': string;
  'team.saveForLater': string;
  'team.unsave': string;
  'team.copyLink': string;
  'team.linkCopied': string;
  'team.remind': string;
  'team.remindIn20m': string;
  'team.remindIn1h': string;
  'team.remindTomorrow': string;
  'team.markUnread': string;
  'team.quote': string;
  'team.emoji': string;
  'team.mention': string;
  'team.bold': string;
  ...
  'team.strike': string;
  'team.code': string;
  'team.schedule': string;
  'team.schedule1h': string;
  'team.jumpLatest': string;
  'team.loadOlder': string;
  'team.profile': string;
  'team.setStatus': string;
  'team.clearStatus': string;
  'team.statusPlaceholder': string;
  'team.active': string;
  'team.away': string;
  'team.noActivity': string;
  'team.noSaved': string;
  'team.noPins': string;
  'team.noFiles': string;
  'team.mentionedYou': string;
  'team.reacted': string;
  'team.replied': string;
  'team.reminderDue': string;
  'team.details': string;
  'team.closeDetails': string;
  'team.channelPref': string;
  'team.jumpTo': string;
  'team.bookmarkAdd': string;
  'team.bookmarks': string;
  'team.archive': string;
  'team.unarchive': string;
  'team.reminders': string;
  'team.scheduled': string;
  'team.noReminders': string;
  'team.noScheduled': string;
  'team.cancelReminder': string;
  'team.cancelSend': string;
  'team.markAllRead': string;
  'team.alsoSendToChannel': string;
  'team.shareTo': string;
  'team.share': string;
  'team.unreadDivider': string;
  'team.schedule20m': string;
  'team.scheduleTomorrow': string;
  'team.scheduledOk': string;
  'team.shortcuts': string;
  'team.shortcutsBody': string;
  'team.searchInChannel': string;
  'team.enableNotifications': string;
  'team.notificationsOn': string;
  'team.notificationsDenied': string;
  'team.removeBookmark': string;
  'team.dms': string;
  'team.draft': string;
  'team.slashHint': string;
  'team.snooze30': string;
  'team.forwardedFrom': string;
  'team.threadReplies': string;
  'team.huddleLive': string;
  'team.huddleStart': string;
  'team.huddleJoin': string;
  'team.huddleLeave': string;
  'team.huddleMute': string;
  'team.huddleUnmute': string;
  'team.huddleInProgress': string;
  'team.customEmoji': string;
  'team.someoneTyping': string;
  'team.oneTyping': string;
  'team.twoTyping': string;
  'team.manyTyping': string;
  'team.quietHours': string;
  'team.pauseNotifications': string;
  'team.resumeNotifications': string;
  'team.reconnecting': string;
  'team.newSection': string;
  'team.deleteSection': string;
  'team.sectionEmpty': string;
  'team.section': string;
  'team.noSection': string;
  'team.whoCanPost': string;
  'team.postEveryone': string;
  'team.postAdmins': string;
  'pages.title': string;
  'pages.lead': string;
  'pages.noOrg': string;
  'pages.noOrgBody': string;
  'pages.pages': string;
  'pages.newPage': string;
  'pages.save': string;
  'pages.saving': string;
  'pages.untitled': string;
  'pages.emptyTitle': string;
  'pages.emptyBody': string;
  'pages.titleField': string;
  'pages.blockType': string;
  'pages.blockPlaceholder': string;
  'pages.removeBlock': string;
  'pages.todoDone': string;
  'pages.databaseTableId': string;
  'pages.artifactPath': string;
  'pages.addParagraph': string;
  'pages.addHeading': string;
  'pages.addBullet': string;
  'pages.addTodo': string;
  'pages.addCallout': string;
  'pages.addCode': string;
  'pages.addTable': string;
  'pages.addDatabase': string;
  'pages.addArtifact': string;
  'pages.addDivider': string;
  'pages.archive': string;
  'pages.editorHint': string;
  'pages.changeIcon': string;
  'pages.addSubpage': string;
  'pages.saved': string;
  ...
  'pages.changeCover': string;
  'pages.removeCover': string;
  'pages.duplicate': string;
  'pages.more': string;
  'pages.childPages': string;
  'pages.star': string;
  'pages.unstar': string;
  'pages.hideSidebar': string;
  'pages.showSidebar': string;
  'pages.noMatch': string;
  'pages.askAi': string;
  'pages.askPlaceholder': string;
  'pages.buildWiki': string;
  ...
  'pages.builderPages': string;
  'pages.builderOpen': string;
  'pages.exportMarkdown': string;
  'pages.copyLink': string;
  'pages.send': string;
  'pages.send.lead': string;
  'pages.send.exceptHint': string;
  'pages.copied': string;
  'pages.moveTo': string;
  'pages.moveToRoot': string;
  'pages.lock': string;
  'pages.unlock': string;
  'pages.customize': string;
  'pages.fullWidth': string;
  'pages.smallText': string;
  'pages.font': string;
  'pages.fontDefault': string;
  'pages.fontSerif': string;
  'pages.fontMono': string;
  'pages.lastEdited': string;
  'pages.wordCount': string;
  'pages.templates': string;
  'pages.templateBlank': string;
  'pages.templateMeeting': string;
  'pages.templateDoc': string;
  'pages.templateTasks': string;
  'entry.navPages': string;
  'entry.navSearch': string;
  'entry.navCalendar': string;
  'entry.navMail': string;
  'entry.navSlack': string;
  'entry.navDev': string;
  'search.title': string;
  ...
  'search.needOrg': string;
  'search.needOrgBody': string;
  'search.emptyTitle': string;
  'search.scopeHint': string;
  'search.kind.project': string;
  'search.kind.file': string;
  'search.kind.page': string;
  'search.kind.app': string;
  'search.kind.chat': string;
  'search.kind.record': string;
  'search.kind.calendar': string;
  'search.kind.destination': string;
  'search.kind.asset': string;
  'search.uploadAssets': string;
  'search.kind.import': string;
  'search.importLink': string;
  'calendar.title': string;
  'calendar.subtitle': string;
  'calendar.needOrg': string;
  'calendar.needOrgBody': string;
  'calendar.prev': string;
  'calendar.next': string;
  'calendar.today': string;
  'calendar.newEvent': string;
  'calendar.editEvent': string;
  'calendar.syncing': string;
  'calendar.syncGoogle': string;
  'calendar.connectGoogle': string;
  'calendar.lastSynced': string;
  'calendar.noEvents': string;
  'calendar.addForDay': string;
  'calendar.allDay': string;
  'calendar.fromGoogle': string;
  'calendar.eventEditor': string;
  'calendar.fieldTitle': string;
  'calendar.starts': string;
  'calendar.ends': string;
  'calendar.location': string;
  'calendar.description': string;
  'calendar.delete': string;
  'calendar.cancel': string;
  'calendar.save': string;
  'calendar.send': string;
  'calendar.send.lead': string;
  'calendar.send.exceptHint': string;
  'calendar.send.needTitle': string;
  'calendar.saving': string;
  'calendar.openIntegrations': string;
  'calendar.connecting': string;
  'calendar.statusDisconnected': string;
  'calendar.statusPending': string;
  'calendar.statusConnected': string;
  'calendar.connectFirst': string;
  'calendar.connectTimeout': string;
  'calendar.composioRequired': string;
  'calendar.views': string;
  'calendar.view.month': string;
  'calendar.view.week': string;
  'calendar.view.day': string;
  'calendar.view.agenda': string;
  'calendar.searchPlaceholder': string;
  'calendar.import': string;
  'calendar.importTitle': string;
  'calendar.importBody': string;
  'calendar.importGoogle': string;
  'calendar.importNotion': string;
  'calendar.importApple': string;
  'calendar.connectNotion': string;
  'calendar.syncNotion': string;
  'calendar.fromNotion': string;
  'calendar.fromApple': string;
  'calendar.icsFile': string;
  'calendar.icsUrl': string;
  'calendar.icsUrlPlaceholder': string;
  'calendar.icsPaste': string;
  'calendar.importing': string;
  'calendar.calendars': string;
  'calendar.addCalendar': string;
  'calendar.newCalendar': string;
  'calendar.calendarName': string;
  'calendar.recurrence': string;
  ...
  'calendar.attendees': string;
  'calendar.fieldCalendar': string;
  'calendar.appleHelp': string;
  'calendar.notionHelp': string;
  'calendar.googleHelp': string;
  'calendar.statusNotion': string;
  'calendar.connectNotionFirst': string;
  'calendar.notionTimeout': string;
  'calendar.notionComposio': string;
  'calendar.agendaEmpty': string;
  'calendar.people': string;
  'calendar.myCalendar': string;
  'calendar.kind.shared': string;
  'calendar.kind.team': string;
  'calendar.kind.personal': string;
  'calendar.teamCalendar': string;
  'calendar.addTeamCalendar': string;
  'calendar.pickTeam': string;
  'calendar.noTeams': string;
  'calendar.openOrganization': string;
  'calendar.overlayHint': string;
  'calendar.scheduleOf': string;
  'calendar.busyAtTime': string;
  'calendar.freeAtTime': string;
  'calendar.guestPeople': string;
  'calendar.guestTeams': string;
  'calendar.guestSearch': string;
  'calendar.noGuests': string;
  'calendar.otherGuests': string;
  'calendar.goingOn': string;
  'calendar.newCalendarKind': string;
  'calendar.bookingLinks': string;
  'calendar.booking.title': string;
  'calendar.booking.body': string;
  'calendar.booking.create': string;
  'calendar.booking.creating': string;
  'calendar.booking.empty': string;
  'calendar.booking.copy': string;
  'calendar.booking.copied': string;
  'calendar.booking.revoke': string;
  'calendar.booking.duration': string;
  'calendar.booking.hoursStart': string;
  'calendar.booking.hoursEnd': string;
  'calendar.booking.weekdays': string;
  'calendar.inviteDownload': string;
  'book.loading': string;
  'book.invalid': string;
  'book.invalidBody': string;
  'book.with': string;
  'book.minutes': string;
  'book.pickDay': string;
  'book.pickTime': string;
  'book.noSlots': string;
  'book.name': string;
  'book.email': string;
  'book.confirm': string;
  'book.confirming': string;
  'book.confirmed': string;
  'book.downloadIcs': string;
  'book.googleCalendar': string;
  'book.goHome': string;
  'book.prev': string;
  'book.next': string;
  'mail.title': string;
  'mail.subtitle': string;
  'mail.needOrg': string;
  'mail.needOrgBody': string;
  'mail.connectGmail': string;
  'mail.connecting': string;
  'mail.statusDisconnected': string;
  'mail.statusPending': string;
  'mail.statusConnected': string;
  'mail.openIntegrations': string;
  'mail.composioRequired': string;
  'mail.connectTimeout': string;
  'mail.search': string;
  'mail.searchPlaceholder': string;
  'mail.compose': string;
  'mail.refresh': string;
  'mail.inbox': string;
  'mail.starred': string;
  ...
  'mail.drafts': string;
  'mail.trash': string;
  'mail.important': string;
  'mail.labels': string;
  'mail.empty': string;
  'mail.emptySearch': string;
  'mail.to': string;
  'mail.cc': string;
  'mail.bcc': string;
  'mail.subject': string;
  ...
  'mail.sending': string;
  'mail.reply': string;
  'mail.replying': string;
  'mail.archive': string;
  'mail.star': string;
  'mail.unstar': string;
  'mail.moveTrash': string;
  'mail.cancel': string;
  'mail.noSelection': string;
  'mail.noSelectionBody': string;
  'mail.thread': string;
  'mail.showCc': string;
  'mail.disconnectedBody': string;
  'mail.loadMore': string;
  'mail.needRecipient': string;
  'mail.done': string;
  'mail.markUnread': string;
  'mail.shortcuts': string;
  'mail.shortcutHint': string;
  'mail.commandPlaceholder': string;
  'mail.sendHint': string;
  'mail.all': string;
  'mail.needsReply': string;
  'mail.fyi': string;
  'mail.bulk': string;
  'mail.other': string;
  'mail.triage': string;
  'mail.triaging': string;
  'mail.draftAi': string;
  'mail.drafting': string;
  'mail.summary': string;
  'mail.splitInbox': string;
  'slack.title': string;
  'slack.subtitle': string;
  'slack.needOrg': string;
  'slack.needOrgBody': string;
  'slack.connectSlack': string;
  'slack.connecting': string;
  'slack.statusDisconnected': string;
  'slack.statusPending': string;
  'slack.statusConnected': string;
  'slack.openIntegrations': string;
  'slack.composioRequired': string;
  'slack.connectTimeout': string;
  'slack.search': string;
  'slack.searchPlaceholder': string;
  'slack.refresh': string;
  'slack.channels': string;
  'slack.directMessages': string;
  'slack.emptyChannels': string;
  'slack.emptyMessages': string;
  'slack.emptySearch': string;
  'slack.composePlaceholder': string;
  'slack.send': string;
  'slack.sending': string;
  'slack.disconnectedBody': string;
  'slack.noSelection': string;
  'slack.noSelectionBody': string;
  'slack.thread': string;
  'slack.closeThread': string;
  'slack.replyInThread': string;
  'slack.loadMore': string;
  'slack.messageFailed': string;
  'slack.addReaction': string;
  'github.title': string;
  'github.subtitle': string;
  'github.needOrg': string;
  'github.needOrgBody': string;
  'github.connectGithub': string;
  'github.connecting': string;
  'github.statusDisconnected': string;
  'github.statusPending': string;
  'github.statusConnected': string;
  'github.openIntegrations': string;
  'github.composioRequired': string;
  'github.connectTimeout': string;
  'github.search': string;
  'github.searchPlaceholder': string;
  'github.refresh': string;
  'github.disconnectedBody': string;
  'github.emptyRepos': string;
  'github.noSelection': string;
  'github.noSelectionBody': string;
  'github.pulls': string;
  'github.issues': string;
  'github.actions': string;
  'github.commits': string;
  'github.inbox': string;
  'github.emptyPulls': string;
  'github.emptyIssues': string;
  'github.emptyActions': string;
  'github.emptyCommits': string;
  'github.emptyInbox': string;
  'github.openOnGithub': string;
  'github.star': string;
  'github.importDesignSystem': string;
  'github.importing': string;
  'github.imported': string;
  'github.reviewWithAgent': string;
  'github.merge': string;
  'github.merging': string;
  'github.merged': string;
  'github.comment': string;
  'github.commenting': string;
  'github.commentPlaceholder': string;
  'github.createIssue': string;
  'github.issueTitle': string;
  'github.issueBody': string;
  'github.creating': string;
  'github.cancel': string;
  'github.draft': string;
  'github.private': string;
  'github.noBody': string;
  'entry.navOrganization': string;
  'entry.navDock': string;
  'entry.navDockHint': string;
  'entry.navDockRemove': string;
  'entry.navDockEdit': string;
  'entry.navDockEmptyAdd': string;
  'entry.navDockPlaces': string;
  'entry.navDockApps': string;
  'entry.navDockRemoving': string;
  'entry.navPin': string;
  // Account: who is signed in, and how they leave
  'account.menuAria': string;
  'account.signedInAs': string;
  'account.signOut': string;
  'account.thisComputer': string;
  'account.signInTitle': string;
  'account.signInLead': string;
  'account.username': string;
  'account.usernamePlaceholder': string;
  'account.setUsername': string;
  'account.changeUsername': string;
  'account.usernameHint': string;
  'account.usernameSaved': string;
  'account.usernameTaken': string;
  'account.usernameInvalid': string;
  'account.usernameSaveFailed': string;
  'account.noUsername': string;
  'account.photo': string;
  'account.changePhoto': string;
  'account.removePhoto': string;
  'account.displayName': string;
  'account.displayNamePlaceholder': string;
  'account.bio': string;
  'account.bioPlaceholder': string;
  'account.saveProfile': string;
  'account.profileSaved': string;
  'account.profileSaveFailed': string;
  'account.photoFailed': string;
  // Organizations: switcher, members, invites
  'org.noOrganization': string;
  'org.switcherLabel': string;
  'org.memberCount': string;
  'org.newOrgName': string;
  'org.create': string;
  'org.createOrganization': string;
  'org.manage': string;
  'org.membersTitle': string;
  'org.membersSubtitle': string;
  'org.inviteTitle': string;
  'org.inviteHint': string;
  'org.invitePlaceholder': string;
  'org.sendInvite': string;
  'org.inviteNeedTarget': string;
  'org.inviteTarget': string;
  'org.inviteSentTo': string;
  'org.inviteEmailed': string;
  'org.createInvite': string;
  'org.copyLink': string;
  'org.joinCode': string;
  'org.copyCode': string;
  'org.copied': string;
  'org.dismiss': string;
  'org.linkShownOnce': string;
  'org.members': string;
  'org.person': string;
  'org.reportsTo': string;
  'org.noManager': string;
  'org.role': string;
  'org.status': string;
  'org.active': string;
  'org.removed': string;
  'org.remove': string;
  'org.invites': string;
  'org.kind.link': string;
  'org.kind.email': string;
  'org.kind.username': string;
  'org.pendingInvites': string;
  'org.acceptInvite': string;
  'setup.eyebrow': string;
  'setup.title': string;
  'setup.subtitle': string;
  'setup.joinChoice': string;
  'setup.joinChoiceHint': string;
  'setup.createChoice': string;
  'setup.createChoiceHint': string;
  'setup.pendingTitle': string;
  'setup.joinTitle': string;
  'setup.joinHint': string;
  'setup.joinPlaceholder': string;
  'setup.joinSubmit': string;
  'setup.joinInvalid': string;
  'setup.createTitle': string;
  'setup.createHint': string;
  'setup.createPlaceholder': string;
  'setup.createSubmit': string;
  'setup.createFailed': string;
  'setup.back': string;
  'setup.brandTitle': string;
  'setup.brandHint': string;
  'setup.brandPlaceholder': string;
  'setup.brandSubmit': string;
  'setup.brandSkip': string;
  'setup.brandWorking': string;
  'setup.importTitle': string;
  'setup.importHint': string;
  'setup.importPlaceholder': string;
  'setup.importUrlAction': string;
  'setup.importFile': string;
  'setup.importSubmit': string;
  'setup.importSkip': string;
  'setup.importWorking': string;
  'setup.importConnect': string;
  'setup.importConnectHint': string;
  'setup.importContinue': string;
  'org.uses': string;
  'org.revoked': string;
  'org.revoke': string;
  'org.settings': string;
  ...
  'org.rename': string;
  'org.renameOrganization': string;
  'org.role.owner': string;
  'org.role.admin': string;
  'org.role.member': string;
  'org.role.ownerHint': string;
  'org.role.adminHint': string;
  'org.role.memberHint': string;
  'org.teamsTitle': string;
  'org.teamsHint': string;
  'org.teamsEmpty': string;
  'org.teamNamePlaceholder': string;
  'org.teamDescriptionPlaceholder': string;
  'org.createTeam': string;
  'org.deleteTeam': string;
  'org.teamNeedName': string;
  // Apps gallery
  'apps.create.title': string;
  'apps.create.lead': string;
  'apps.create.menuSection': string;
  'apps.create.menuItem': string;
  'apps.create.menuItemDetail': string;
  'apps.create.new': string;
  'apps.create.audienceOrg': string;
  'apps.create.audienceOrgDetail': string;
  'apps.create.audiencePublic': string;
  'apps.create.audiencePublicDetail': string;
  'apps.create.publishToWeb': string;
  'apps.create.publishToWebHint': string;
  'apps.create.liveUrl': string;
  'apps.create.thisOrg': string;
  'apps.create.workspaceHint': string;
  'apps.create.project': string;
  'apps.create.file': string;
  'apps.create.pickProject': string;
  'apps.create.pickFile': string;
  'apps.create.pickFileFirst': string;
  'apps.create.name': string;
  'apps.create.description': string;
  'apps.create.descriptionPlaceholder': string;
  'apps.create.access': string;
  'apps.create.accessOrg': string;
  'apps.create.accessRestricted': string;
  'apps.create.roleViewer': string;
  'apps.create.roleEditor': string;
  'apps.create.pin': string;
  'apps.create.showAdvanced': string;
  'apps.create.hideAdvanced': string;
  'apps.create.back': string;
  'apps.create.continue': string;
  'apps.create.submit': string;
  'apps.create.creating': string;
  'apps.create.deployWorkspace': string;
  'apps.create.deploying': string;
  'apps.create.needFile': string;
  'apps.create.noMembers': string;
  'apps.create.gmailSend': string;
  'apps.create.gmailSendHint': string;
  'apps.create.dataAccess': string;
  'apps.create.dataAccessHint': string;
  'apps.create.dataAccessEmpty': string;
  'apps.create.dataAccessAsk': string;
  'apps.create.dataAccessConsent': string;
  'apps.create.dataAccessConsentHint': string;
  'apps.create.dataAccessNeedConsent': string;
  'apps.create.dataAccessNeeded': string;
  'apps.create.dataAccessReadAll': string;
  'apps.create.dataModeOff': string;
  'apps.create.dataModeRead': string;
  'apps.create.dataModeWrite': string;
  'apps.create.publicForm': string;
  'apps.create.publicNoData': string;
  'apps.send': string;
  'apps.send.title': string;
  'apps.send.lead': string;
  'apps.send.search': string;
  'apps.send.people': string;
  'apps.send.channels': string;
  'apps.send.note': string;
  'apps.send.notePlaceholder': string;
  'apps.send.action': string;
  'apps.send.sending': string;
  'apps.send.sent': string;
  'apps.send.skip': string;
  'apps.send.openChat': string;
  'apps.send.empty': string;
  'apps.send.needPick': string;
  'apps.send.defaultBody': string;
  'apps.send.created': string;
  'apps.send.createdLead': string;
  'apps.send.teams': string;
  'apps.send.except': string;
  'apps.send.exceptHint': string;
  'apps.access.org': string;
  'apps.access.orgDetail': string;
  'apps.access.restricted': string;
  'apps.access.restrictedDetail': string;
  'apps.except': string;
  'apps.exceptHint': string;
  'apps.grant.view': string;
  'apps.grant.edit': string;
  'apps.pin': string;
  'apps.unpin': string;
  'apps.pinned': string;
  'apps.more': string;
  'apps.previewOf': string;
  'apps.manageAccess': string;
  'apps.previewLink': string;
  'apps.previewLinkWarning': string;
  'apps.publishToWeb': string;
  'apps.publishingToWeb': string;
  'apps.copyWebLink': string;
  'apps.copiedWebLink': string;
  'apps.publishToWebHint': string;
  'apps.liveOnWeb': string;
  'apps.title': string;
  ...
  'apps.archive': string;
  'apps.dismiss': string;
  'apps.visibility': string;
  'apps.visibility.private': string;
  'apps.visibility.org': string;
  'apps.visibility.link': string;
  'apps.shareWarning': string;
  'apps.byline': string;
  'apps.bylineUnknown': string;
  'apps.neverOpened': string;
  'apps.minutesAgo': string;
  'apps.hoursAgo': string;
  'apps.daysAgo': string;
  // Invite landing page
  'join.eyebrow': string;
  'join.roleLine': string;
  'join.accept': string;
  'join.loading': string;
  'join.joining': string;
  'join.joined': string;
  'join.cannotJoin': string;
  'join.expired': string;
  'join.revoked': string;
  'join.exhausted': string;
  'join.invalid': string;
  'join.wrongRecipient': string;
  'join.restrictedHint': string;
  'join.goHome': string;
  // Workspace Database tab (permanent structured data plane)
  'database.title': string;
  'database.subtitle': string;
  'database.workspace': string;
  'database.newWorkspaceName': string;
  'database.create': string;
  'database.tables': string;
  'database.noTables': string;
  'database.newTable': string;
  'database.tableName': string;
  'database.fieldName': string;
  'database.fieldType': string;
  'database.required': string;
  'database.unique': string;
  'database.addField': string;
  'database.createTable': string;
  'database.records': string;
  'database.noRecords': string;
  'database.addRecord': string;
  'database.deleted': string;
  'database.delete': string;
  'database.restore': string;
  'database.history': string;
  'database.audit': string;
  'database.revision': string;
  'database.showDeleted': string;
  'database.loadError': string;
  'database.saveError': string;
  ...
  'pluginsHome.titleFallback': string;
  ...
  'phone.lede': string;
  'phone.slack': string;
  'phone.imessage': string;
  'phone.connectSlack': string;
  'phone.connectIMessage': string;
  'phone.slackBody': string;
  'phone.imessageBody': string;
  'phone.pickChannel': string;
  'phone.channelPlaceholder': string;
  'phone.needSlack': string;
  'phone.pairingCode': string;
  'phone.pairingIMessage': string;
  'phone.webhookUrl': string;
  'phone.secret': string;
  'phone.secretOnce': string;
  'phone.copy': string;
  'phone.replyUrl': string;
  'phone.replyUrlHint': string;
  'phone.replyUrlPlaceholder': string;
  'phone.pause': string;
  'phone.resume': string;
  'phone.remove': string;
  'phone.empty': string;
  'phone.loading': string;
  'phone.status.pairing': string;
  'phone.status.active': string;
  'phone.status.paused': string;
  'phone.helpIMessage': string;
  'integrations.agentReady': string;
  'integrations.areasAria': string;
  'integrations.advanced': string;
  'integrations.advancedAria': string;
  ...
  'newproj.visibilityLabel': string;
  'newproj.visibilityPrivate': string;
  'newproj.visibilityPrivateDetail': string;
  'newproj.visibilityPublic': string;
  'newproj.visibilityPublicDetail': string;
  'newproj.visibilityRequired': string;
  ...
  'chat.mentionSectionPeople': string;
  ...
  'publish.subtitle': string;
  'publish.notConfigured': string;
  'publish.signInRequired': string;
  'publish.addressLabel': string;
  'publish.slugHint': string;
  'publish.slugChecking': string;
  'publish.slugAvailable': string;
  'publish.visibilityLabel': string;
  'publish.visibilityPublic': string;
  'publish.visibilityPublicDetail': string;
  'publish.visibilityOrg': string;
  'publish.visibilityOrgDetail': string;
  'publish.visibilityOrgUnavailable': string;
  'publish.progressPreparing': string;
  'publish.versionsLabel': string;
  'publish.versionFileCount': string;
  'publish.versionLive': string;
  'publish.rollback': string;
  'publish.unpublish': string;
  'publish.close': string;
  'publish.publish': string;
  'publish.republish': string;
  'publish.publishing': string;
  'publish.copy': string;
  'publish.copied': string;
  'publish.menuItem': string;
  'publish.menuItemDetail': string;
}
