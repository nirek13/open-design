...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Substrate Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to Substrate Cloud & retry',
  'chat.amrError.authMessage': 'Your Substrate Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Substrate Cloud balance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Substrate Cloud',
  ...
  'chat.amrBalanceGate.signedOutTitle': 'Authorize models to start',
  'chat.amrBalanceGate.signedOutMessage': 'You are signed in. Authorize Substrate Cloud models and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The Substrate Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Substrate Cloud agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update Substrate to the latest version, which ships a compatible runtime.",
  ...
  'settings.welcomeTitle': 'Welcome to Plyxl',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Substrate will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Substrate reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingCloudTitle': 'Authorize Substrate Cloud',
  'settings.onboardingCloudBody': 'You are already signed in. Authorize models so this workspace can run without extra API keys. Bring-your-own-key stays in advanced settings.',
  'settings.onboardingCloudSignIn': 'Authorize models',
  'settings.onboardingCloudContinue': 'Continue (signed in)',
  'settings.onboardingCloudAlternative': 'Use a local CLI or your own API key (advanced)',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — authorize Substrate Cloud models to continue.',
  ...
  'settings.onboardingByokTitle': 'Bring your own key (advanced)',
  'settings.onboardingByokBody': 'Use your own model provider credentials. This is an advanced agent setting, not a second account.',
  ...
  'settings.subtitle': 'Local CLI is the default. Bring-your-own-key is an advanced agent setting.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Substrate daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Substrate.',
  ...
  'settings.amrAccountStatus': 'Substrate Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose Substrate as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Substrate team',
  'settings.privacyConsentKicker': 'Help us improve Substrate',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how Substrate performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Substrate starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Substrate could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Substrate projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Substrate is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Substrate, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'Substrate must be running for MCP tool calls to succeed. If you started your coding agent before opening Substrate, restart the agent so it can reach the live daemon.',
  'entry.tabDesigns': 'Designs',
  'entry.tabTemplates': 'Templates',
  'entry.tabDesignSystems': 'Design systems',
  'entry.tabConnectors': 'Connected accounts',
  'entry.openSettingsTitle': 'Settings',
  'entry.openSettingsAria': 'Open settings',
  'entry.discordLabel': 'Join Discord',
  'entry.discordAria': 'Join the Substrate Discord',
  'entry.discordAriaWithOnline': 'Join the Substrate Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow Substrate on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Substrate on Xiaohongshu',
  ...
  'entry.navExpand': 'Show sidebar labels',
  'entry.navCollapse': 'Hide sidebar labels',
  'entry.navAtlas': 'Places',
  'entry.navAtlasHint': 'Go somewhere, or add it to your sidebar.',
  'entry.navOpenAtlas': 'Open places',
  'entry.navCloseAtlas': 'Close places',
  'entry.navIslandWork': 'Work',
  'entry.navIslandMake': 'Make',
  'entry.navIslandConnect': 'Connect',
  'entry.navIslandMore': 'More',
  ...
  'erp.connections.title': 'Connected accounts',
  ...
  'erp.connections.browseAll': 'All connected accounts',
  ...
  'erp.netsuite.body': 'Connect NetSuite as your system of record. Keep Substrate ERP for day-to-day work, and pull live NetSuite data through Connect.',
  ...
  'workspace.magicImportHint': 'Turn a public sheet, CSV, or page into a table. Drop a file anywhere.',
  'workspace.dropToImport': 'Drop a file to import',
  'workspace.greetingMorning': 'Good morning',
  'workspace.greetingAfternoon': 'Good afternoon',
  'workspace.greetingEvening': 'Good evening',
  ...
  'workspace.dataSources': 'Data sources',
  'workspace.openTable': 'Open table',
  ...
  'workspace.heroLead': 'Describe what you want and it gets built — a page, a deck, a table, a document.',
  'workspace.startersLabel': 'Starting points',
  'workspace.starterSiteLabel': 'Landing page',
  'workspace.starterSitePrompt': 'Design a landing page for a new product, with a hero, three feature sections, and a sign-up form.',
  'workspace.starterDeckLabel': 'Pitch deck',
  'workspace.starterDeckPrompt': 'Make a 10-slide pitch deck covering the problem, the product, the market, and the ask.',
  'workspace.starterTableLabel': 'Track something',
  'workspace.starterTablePrompt': 'Create a table to track customers, with a name, company, status, and last contacted date.',
  'workspace.starterDocLabel': 'Write a brief',
  'workspace.starterDocPrompt': 'Write a one-page project brief with goals, scope, milestones, and open questions.',
  ...
  'builder.importHint': 'CSV, JSON, a Google Sheet, or any public page',
  'builder.importBody': 'Paste a public link — a Google Sheet, CSV, JSON, HTML table, or any page. Open-data dumps and bilingual files are fine. We show a preview, then you can build an interface or keep the link fresh.',
  'builder.importAction': 'Choose a file',
  'builder.importCommit': 'Import',
  'builder.importUrlPlaceholder': 'https://… a page, Google Sheet, CSV, or JSON',
  'builder.importUrlAction': 'Scrape',
  'builder.importUrlHint': 'Or drop a CSV, TSV, or JSON file below.',
  ...
  'builder.previewTitle': 'What we found',
  'builder.sourceLink': 'Open source',
  'builder.previewMore': '{count} more row(s)',
  ...
  'builder.nextBuildHint': 'Tell the builder what this app should do',
  ...
  'books.yes': 'Yes',
  'books.no': 'No',
  'apps.allOrganizations': 'All workspaces',
  'apps.filterByOrg': 'Filter by workspace',
  'apps.countShown': '{count} app(s)',
  'apps.subtitleAcrossOrgs': 'Tools published across every workspace you belong to.',
  'apps.emptyBody': 'Add an app from a project file so your team can open it in this workspace.',
  'crm.title': 'CRM',
  'crm.lead': 'Contacts, deals, and what is likely to close.',
  'crm.noOrg': 'Pick a workspace to see its pipeline.',
  'crm.board': 'Pipeline',
  'crm.refresh': 'Refresh',
  'crm.openValue': 'Open',
  ...
  'pages.openTabs': 'Open pages',
  'pages.closeTab': 'Close tab',
  ...
  'entry.navDev': 'Dev',
  'search.title': 'Search',
  'search.subtitle': 'Find a place, an app, an asset, or anything you already have.',
  'search.placeholder': 'Search places, apps, assets…',
  'search.clear': 'Clear',
  ...
  'search.emptyTitle': 'Jump to a place, app, or asset',
  'search.scopeHint': 'Type to search, or pick a destination. Upload adds files to Assets.',
  ...
  'search.kind.destination': 'Place',
  'search.kind.asset': 'Asset',
  'search.uploadAssets': 'Upload assets',
  'search.kind.import': 'Import',
  'search.importLink': 'Turn this link into data',
  'mail.title': 'Mail',
  'mail.subtitle': 'Read at keyboard speed. Triage sorts and marks; Draft writes a reply you can send.',
  ...
  'mail.noSelectionBody': 'J/K to move through the list, Space to done, D to draft a reply.',
  ...
  'mail.commandPlaceholder': 'Jump, compose, triage, draft…',
  ...
  'entry.navOrganization': 'People',
  'entry.navDock': 'Sidebar',
  'entry.navDockHint': 'Click to open. Drag to reorder. Right-click to remove.',
  'entry.navDockRemove': 'Remove from sidebar',
  'entry.navDockEdit': 'Add to sidebar',
  'entry.navDockEmptyAdd': 'Everything is already in the sidebar',
  'entry.navDockPlaces': 'Places',
  'entry.navDockApps': 'Apps',
  'entry.navDockRemoving': 'Drop to remove',
  'entry.navPin': 'Add to sidebar',
  'account.menuAria': 'Account',
  'account.signedInAs': 'Signed in',
  'account.signOut': 'Sign out',
  'account.thisComputer': 'This computer',
  'account.signInTitle': 'Sign in to Plyxl',
  'account.signInLead': 'Sign in or create a new account to continue.',
  ...
  'org.noOrganization': 'No workspace',
  'org.switcherLabel': 'Your workspaces',
  'org.memberCount': '{count} members',
  'org.newOrgName': 'New workspace name',
  'org.create': 'Create',
  'org.createOrganization': 'New workspace',
  'org.manage': 'Manage workspace',
  'org.membersTitle': 'People',
  'org.membersSubtitle': 'Everyone who can see this workspace’s projects, apps, and data.',
  'org.inviteTitle': 'Invite someone',
  'org.inviteHint': 'Invite by email or username, or create a link anyone can open.',
  'org.invitePlaceholder': 'name@company.com or username',
  'org.sendInvite': 'Send invite',
  'org.inviteNeedTarget': 'Enter an email or username, or create a link instead.',
  'org.inviteTarget': 'To',
  'org.inviteSentTo': 'Send this link to {target}. It is shown once and cannot be retrieved later.',
  'org.inviteEmailed': 'Invite emailed to {target} via Gmail. The link is shown once and cannot be retrieved later.',
  'org.createInvite': 'Create invite link',
  'org.copyLink': 'Copy link',
  'org.joinCode': 'Join code',
  'org.copyCode': 'Copy code',
  'org.copied': 'Copied',
  'org.dismiss': 'Dismiss',
  'org.linkShownOnce': 'This link is shown once. Copy it now — it cannot be retrieved later.',
  'org.members': 'Members',
  'org.person': 'Person',
  ...
  'org.remove': 'Remove',
  'org.invites': 'Invites',
  'org.kind.link': 'Anyone with the link',
  'org.kind.email': 'Email',
  'org.kind.username': 'Username',
  'org.pendingInvites': 'Invites for you',
  'org.acceptInvite': 'Join',
  ...
  'org.organizationName': 'Workspace name',
  'org.rename': 'Rename',
  'org.renameOrganization': 'Rename workspace',
  'org.role.owner': 'Owner',
  'org.role.admin': 'Admin',
  'org.role.member': 'Member',
  'org.role.ownerHint': 'Can change roles, remove people, and manage the workspace.',
  'org.role.adminHint': 'Can invite people, rename the workspace, and create teams.',
  ...
  'apps.create.title': 'Add app',
  'apps.create.lead': 'Put this in your workspace for the team, or publish a public web link.',
  'apps.create.menuSection': 'Apps',
  'apps.create.menuItem': 'Add to workspace',
  'apps.create.menuItemDetail': 'Team app or public link',
  'apps.create.new': 'Add app',
  'apps.create.audienceOrg': 'Add to workspace',
  'apps.create.audienceOrgDetail': 'Members of {org} can open it from Apps. Pin it to the sidebar if you want.',
  'apps.create.audiencePublic': 'Public web link',
  'apps.create.audiencePublicDetail': 'One click. Anyone with the URL can open it — no extra account.',
  ...
  'apps.create.thisOrg': 'this workspace',
  'apps.create.workspaceHint': 'Adds this to {org}. Everyone in the workspace can open it from Apps.',
  ...
  'apps.create.accessOrg': 'Everyone in the workspace',
  ...
  'apps.create.deployWorkspace': 'Add to workspace',
  ...
  'apps.create.dataAccessHint': 'Existing workspace tables are listed here. Grant Read or Write for each one this app should use. Public links can append only to tables marked Public form.',
  ...
  'apps.send.lead': 'Drop it in a channel, a team, or a DM. Leave people off — or explicitly don’t send to them.',
  ...
  'apps.pinned': 'Pinned',
  'apps.more': 'More',
  'apps.previewOf': 'Preview of {name}',
  ...
  'apps.title': 'Apps',
  'apps.subtitle': 'Tools your team published. A project is where you build; an app is what your coworkers open.',
  'apps.empty': 'No apps yet. Publish a tool from a project to put it here.',
  'apps.share': 'Share',
  'apps.archive': 'Archive',
  'apps.dismiss': 'Dismiss',
  'apps.visibility': 'Visibility',
  'apps.visibility.private': 'Only me',
  'apps.visibility.org': 'Everyone in the organization',
  'apps.visibility.link': 'Anyone with the link',
  'apps.shareWarning': 'This link is shown once. Anyone holding it can open this app.',
  'apps.byline': 'by {name}',
  'apps.bylineUnknown': 'Published',
  'apps.neverOpened': 'Never opened',
  'apps.minutesAgo': '{count}m ago',
  'apps.hoursAgo': '{count}h ago',
  'apps.daysAgo': '{count}d ago',
  'join.eyebrow': 'You have been invited to join',
  'join.roleLine': 'You will join as {role}.',
  'join.accept': 'Join organization',
  'join.loading': 'Checking this invite…',
  'join.joining': 'Joining…',
  'join.joined': 'You are in. Taking you there…',
  'join.cannotJoin': 'This invite cannot be used',
  'join.expired': 'This invite link has expired.',
  'join.revoked': 'This invite link was revoked.',
  'join.exhausted': 'This invite link has reached its limit.',
  'join.invalid': 'This invite link is not valid.',
  'join.wrongRecipient': 'This invite was sent to someone else. Sign in as the person it was meant for.',
  'join.restrictedHint': 'This invite is for a specific person. Sign in as them to join.',
  'join.goHome': 'Go home',
  'database.title': 'Company database',
  'database.subtitle': 'Permanent, structured tables that every tool builds on. Tools are disposable — this data is not.',
  'database.workspace': 'Workspace',
  'database.newWorkspaceName': 'New workspace name',
  'database.create': 'Create',
  'database.tables': 'Tables',
  'database.noTables': 'No tables yet. Create one here, or ask the agent to build a tool that needs one.',
  'database.newTable': 'New table',
  'database.tableName': 'Table name (snake_case)',
  'database.fieldName': 'Field name',
  'database.fieldType': 'Type',
  'database.required': 'Required',
  'database.unique': 'Unique',
  'database.addField': 'Add field',
  'database.createTable': 'Create table',
  'database.records': 'Records',
  'database.noRecords': 'No records yet.',
  'database.addRecord': 'Add record',
  ...
  'database.showDeleted': 'Show deleted',
  'database.loadError': 'Could not load the database.',
  'database.saveError': 'Save failed',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Substrate plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Substrate Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local Substrate project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Substrate Systems to view the full preview.',
  ...
  'pluginsHome.title': 'Created by others in {org}',
  'pluginsHome.titleFallback': 'Created by others',
  'pluginsHome.subtitle': 'Ready-to-use Substrate workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Substrate and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Substrate',
  'pluginCard.contributeTitle': 'Contribute plugin to Substrate with a pull request',
  ...
  'integrations.kicker': 'Connect',
  'integrations.lede': 'Connect the accounts this workspace uses. MCP tools and CLI access live here as advanced options.',
  ...
  'integrations.areasAria': 'Connect areas',
  'integrations.advanced': 'Advanced',
  'integrations.advancedAria': 'Advanced Connect options',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Substrate is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Substrate everywhere',
  'useEverywhere.modalTitle': 'Use Substrate everywhere',
  'useEverywhere.modalSubtitle': 'Drop Substrate into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Substrate works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Substrate is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Substrate as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Substrate at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Substrate from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Substrate as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Substrate ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Substrate tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Substrate app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Substrate running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Substrate extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Substrate and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Substrate extras)',
  ...
  'entry.githubStarAria': 'Star Substrate on GitHub',
  ...
  'connectors.title': 'Connected accounts',
  'connectors.subtitle': 'OAuth accounts and APIs the agent and work surfaces can use.',
  ...
  'connectors.emptyNoMatchAction': 'Clear',
  ...
  'newproj.locationDefault': 'Substrate projects',
  ...
  'newproj.visibilityLabel': 'Visibility',
  'newproj.visibilityPrivate': 'Private',
  'newproj.visibilityPrivateDetail': 'Only people in your organization can use it.',
  'newproj.visibilityPublic': 'Public',
  'newproj.visibilityPublicDetail': 'Gets a public web link anyone can open — no account needed.',
  'newproj.visibilityRequired': 'Choose Private or Public to continue.',
  ...
  'avatar.amrConsole': 'Substrate Cloud',
  ...
  'socialShare.openDesignSection': 'Share Substrate',
  'socialShare.openDesignTitle': 'Substrate on GitHub',
  'socialShare.openDesignText': 'Substrate is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Substrate: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Substrate: {title}\n{url}\nSubstrate repo: {repo}',
  'socialShare.deployFirst': 'Export then share…',
  ...
  'brandEnrichment.body': "Substrate will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Substrate to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Substrate to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'chat.mentionTabPeople': 'People',
  'chat.mentionNoResults': 'No results for “{query}”.',
  'chat.mentionSearchPrompt': 'Search people, Design Files, tabs, plugins, skills, MCP servers, and connectors.',
  ...
  'chat.mentionSectionPeople': 'People',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Substrate is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip5': 'Out of ideas? Try a template created by others on the Home page.',
  'designFiles.usefulInfoTip6': 'Questions or feedback? Join us on Discord.',
  'designFiles.usefulInfoTip7': 'Enjoying Substrate? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to Substrate on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Substrate on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Substrate on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.deployToVercel': 'Export to Vercel',
  'fileViewer.redeployToVercel': 'Export again',
  'fileViewer.deployingToVercel': 'Exporting to Vercel…',
  ...
  'fileViewer.deployToProvider': 'Export to {provider}',
  'fileViewer.redeployToProvider': 'Export again to {provider}',
  'fileViewer.deployingToProvider': 'Exporting to {provider}…',
  'fileViewer.preparingPublicLink': 'Preparing public link…',
  'fileViewer.copyDeployLink': 'Copy link',
  'fileViewer.deployModalTitle': 'Export',
  'fileViewer.deployModalSubtitle': 'Use your own provider account to export this HTML preview. Publishing a public site stays in Publish.',
  ...
  'assistant.shareToOpenDesign': 'Share to Substrate',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Substrate — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Substrate — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Substrate project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.connectorsNavHint': 'Opens Connect',
  ...
  'settings.customInstructionsHint': 'Fixed instructions Substrate should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'Substrate {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'Substrate is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'Substrate could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. Substrate is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Substrate',
  'updater.quitFailedBody': 'The installer is open, but Substrate could not quit. Quit Substrate before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Substrate will close and open the installer.',
  'updater.readyVersion': 'Substrate {version} is ready. Substrate will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. Substrate will close and open the installer.',
  'updater.reinstallReadyVersion': 'Substrate {version} requires a full reinstall. Substrate will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach Substrate your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Substrate follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Substrate your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Substrate turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'publish.title': 'Publish to the web',
  'publish.subtitle': 'Anyone with the link can open this in a browser. No install required.',
  'publish.notConfigured': 'Hosting is not configured on this daemon.',
  'publish.signInRequired': 'Sign in to publish this to the web.',
  'publish.addressLabel': 'Web address',
  'publish.slugHint': 'Letters, numbers, and hyphens.',
  'publish.slugChecking': 'Checking availability…',
  'publish.slugAvailable': 'Available',
  'publish.visibilityLabel': 'Who can open it',
  'publish.visibilityPublic': 'Anyone',
  'publish.visibilityPublicDetail': 'Public on the web',
  'publish.visibilityOrg': 'My organization',
  'publish.visibilityOrgDetail': 'Members must sign in',
  'publish.visibilityOrgUnavailable': 'Requires an organization',
  'publish.progressPreparing': 'Preparing files…',
  'publish.versionsLabel': 'Versions',
  'publish.versionFileCount': '{count} files',
  'publish.versionLive': 'Live',
  'publish.rollback': 'Restore',
  ...
  'publish.menuItem': 'Publish instantly',
  'publish.menuItemDetail': 'No account or API token needed',
};
