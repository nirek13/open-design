...
export const en: Dict = {
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Substrate Cloud agent — sign in and this task can start right away.',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Substrate Cloud to continue.',
  ...
  'entry.navOrganization': 'Organization',
  'entry.navDock': 'Sidebar shortcuts',
  'entry.navDockHint': 'Click to open. Drag to rearrange. Right-click to remove.',
  'entry.navDockRemove': 'Remove from sidebar',
  'entry.navDockEdit': 'Add or remove shortcuts',
  'entry.navDockEmptyAdd': 'All shortcuts are in the sidebar',
  ...
  'org.switcherLabel': 'Your organizations',
  'org.memberCount': '{count} members',
  'org.newOrgName': 'New organization name',
  'org.create': 'Create',
  'org.createOrganization': 'New organization',
  'org.manage': 'Manage organization',
  'org.membersTitle': 'People',
  'org.membersSubtitle': 'Everyone who can see this organization’s projects, apps, and data.',
  ...
  'apps.create.menuSection': 'Deploy',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Substrate from other IDEs, scripts, and automations.',
