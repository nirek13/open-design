...
export const en: Dict = {
  ...
  'workspace.subtitle': 'Ask to change the work. Approvals and recent records stay below.',
  ...
  'workspace.magicImport': 'Import a link',
  ...
  'workspace.askPlaceholder': 'Paste a public link to turn it into data, or ask to change a record…',
  'workspace.askSubmit': 'Ask',
  'workspace.askHint': 'A link becomes a table. Everything else stays here or opens as a project.',
  ...
  'entry.navDockHint': 'Drag to reorder. Right-click to remove.',
