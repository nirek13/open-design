...
export const en: Dict = {
  ...
  'settings.welcomeTitle': 'Welcome to Substrate',
  ...
  'mail.title': 'Mail',
  'mail.subtitle': 'Keyboard-first Gmail. J/K to move, Enter to open, C to compose.',
  ...
  'mail.noSelectionBody': 'J/K to move through the list, Enter to open, E to archive.',
  ...
  'account.signInTitle': 'Sign in to Substrate',
