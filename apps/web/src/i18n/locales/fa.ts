...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل Substrate Cloud سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'chat.amrCard.switchCta': 'سوئیچ به Substrate Cloud و تلاش مجدد',
  'chat.amrError.authMessage': 'حساب Substrate Cloud شما هنوز مجاز نشده است. آن را مجاز کنید تا این اجرا به‌طور خودکار دوباره انجام شود.',
  'chat.amrError.balanceMessage': 'موجودی Substrate Cloud شما تمام شده است. برای ادامه این اجرا شارژ کنید.',
  'chat.amrError.authorizeCta': 'اعطای دسترسی و تلاش مجدد',
  'chat.amrError.rechargeCta': 'شارژ Substrate Cloud',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'آنچه Substrate Cloud به شما می‌دهد',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'شما از ایجنت Substrate Cloud استفاده می‌کنید — وارد شوید تا این وظیفه بلافاصله شروع شود.',
  ...
  'chat.runError.signInMessage.amr': 'عامل Substrate Cloud هنوز وارد نشده است — برای استفاده وارد شوید.',
  'chat.runError.signInMessage.other': '{agent} وارد نشده است. وضعیت ورود را به‌صورت محلی بررسی کنید. عامل Substrate Cloud را توصیه می‌کنیم — پایدارتر و مقرون‌به‌صرفه‌تر.',
  ...
  'chat.runError.cpuUnsupportedMessage': "محیط اجرای این عامل به مجموعه دستورالعمل پردازنده (AVX2) نیاز دارد که این دستگاه فاقد آن است، بنابراین نمی‌تواند اجرا شود. Substrate را به آخرین نسخه که محیط اجرای سازگار دارد به‌روزرسانی کنید.",
  'common.cancel': 'لغو',
  ...
  'settings.welcomeTitle': 'به Plyxl خوش آمدید',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'شروع با یک شرح',
  'settings.onboardingCreateBody': 'سایت، اپلیکیشن، ارائه، تصویر یا ویدیویی را که می‌خواهید توصیف کنید. Substrate یک پروژه می‌سازد و کار را قابل ویرایش نگه می‌دارد.',
  ...
  'settings.onboardingMemoryCalloutBody': 'این پاسخ‌ها نمایهٔ حافظهٔ شما را شکل می‌دهند. Substrate در هر کار از آن استفاده می‌کند و همزمان با کار شما به یادگیری ادامه می‌دهد.',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': 'مجوزدهی Substrate Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'مراحل بعدی با هوش مصنوعی اجرا می‌شوند — برای ادامه وارد Substrate Cloud شوید.',
  ...
  'settings.agentInstall.stepAuth': 'قبل از بازگشت به Substrate، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.amrAccountStatus': 'وضعیت حساب Substrate Cloud',
  ...
  'settings.amrLoginErrorCompact': 'ورود به Substrate Cloud ناموفق بود.',
  ...
  'settings.mcpServerHint': 'Substrate را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'settings.privacyHint': 'چه داده‌هایی با تیم Substrate به اشتراک گذاشته می‌شود',
  'settings.privacyConsentKicker': 'به ما در بهبود Substrate کمک کنید',
  'settings.privacyConsentLead': 'اشتراک‌گذاری داده‌های استفاده به ما کمک می‌کند عملکرد Substrate را در جریان‌های کاری واقعی بهتر بفهمیم تا بخش‌هایی را که بیشترین اثر را بر تجربه شما دارند بهبود دهیم.',
  ...
  'settings.updateQuitFailed': 'نصب‌کننده باز شد، اما Substrate نتوانست خودکار خارج شود.',
  ...
  'settings.mcpHint': 'به Agentهای کدنویسی (Cursor، Claude Code، VS Code…) اجازه دهید پروژه‌های Substrate شما را مستقیماً بخوانند.',
  'settings.mcpDaemonError': 'امکان دسترسی به daemon محلی برای تعیین مسیرهای نصب وجود نداشت ({error}). مطمئن شوید که Substrate در حال اجراست، سپس این پنل را دوباره باز کنید.',
  ...
  'settings.mcpCapabilityDefault': 'به‌صورت پیش‌فرض از پروژه و فایلی که در Substrate باز کرده‌اید استفاده می‌کند، بنابراین می‌توانید بگویید «این را در اپ من بساز» بدون اینکه دوباره مشخص کنید کدام طراحی.',
  'settings.mcpRunningNote': 'برای موفقیت فراخوانی‌های ابزار MCP، Substrate باید در حال اجرا باشد. اگر Agent کدنویسی خود را پیش از باز کردن Substrate راه‌اندازی کرده‌اید، Agent را راه‌اندازی مجدد کنید تا بتواند به daemon زنده دسترسی پیدا کند.',
  ...
  'entry.followLinkedinLabel': 'دنبال کردن Substrate در LinkedIn',
  'entry.followXiaohongshuLabel': 'دنبال کردن Substrate در Xiaohongshu',
  ...
  'entry.navAtlas': "مکان‌ها",
  'entry.navAtlasHint': "برای رفتن کلیک کنید. تراشه‌ها را روی فضای کار بکشید تا موارد دلخواه نزدیک بمانند.",
  'entry.navOpenAtlas': "باز کردن مکان‌ها",
  'entry.navCloseAtlas': "بستن مکان‌ها",
  'entry.navIslandWork': "کار",
  'entry.navIslandMake': "ساخت",
  'entry.navIslandConnect': "اتصال",
  'entry.navIslandMore': "بیشتر",
  ...
  'entry.navDatabase': 'پایگاه داده',
  'entry.navLibrary': 'دارایی‌ها',
  'entry.navApps': 'برنامه‌ها',
  ...
  'tables.display': 'نمایش',
  'tables.displayCards': 'کارت‌ها',
  'tables.displayTable': 'جدول',
  ...
  'workspace.magicImport': "درون‌ریزی پیوند",
  'workspace.magicImportHint': 'یک شیت، CSV یا صفحهٔ عمومی را به جدول تبدیل می\u200cکند.',
  'workspace.dropToImport': 'برای درون‌ریزی، پرونده را رها کنید',
  'workspace.greetingMorning': 'صبح بخیر',
  'workspace.greetingAfternoon': 'ظهر بخیر',
  'workspace.greetingEvening': 'عصر بخیر',
  'workspace.greetingNamed': '{greeting}، {name}',
  'workspace.uploadAssets': 'بارگذاری دارایی‌ها',
  ...
  'workspace.dataSources': 'منابع داده',
  'workspace.openTable': 'باز کردن جدول',
  ...
  'workspace.heroLead': 'آنچه می‌خواهید را توصیف کنید تا ساخته شود — صفحه، ارائه، جدول یا سند.',
  'workspace.startersLabel': 'نقطه شروع',
  'workspace.starterSiteLabel': 'صفحه فرود',
  'workspace.starterSitePrompt': 'یک صفحه فرود برای محصولی تازه طراحی کن، با بخش اصلی، سه بخش ویژگی و فرم ثبت‌نام.',
  'workspace.starterDeckLabel': 'ارائه سرمایه‌گذاری',
  'workspace.starterDeckPrompt': 'یک ارائه ۱۰ اسلایدی بساز که مسئله، محصول، بازار و مبلغ درخواستی را پوشش دهد.',
  'workspace.starterTableLabel': 'ثبت و پیگیری',
  'workspace.starterTablePrompt': 'جدولی برای پیگیری مشتریان بساز با نام، شرکت، وضعیت و تاریخ آخرین تماس.',
  'workspace.starterDocLabel': 'نوشتن خلاصه',
  'workspace.starterDocPrompt': 'یک خلاصه یک‌صفحه‌ای پروژه بنویس شامل اهداف، دامنه، نقاط عطف و پرسش‌های باز.',
  ...
  'builder.previewTitle': 'آنچه پیدا کردیم',
  'builder.sourceLink': 'باز کردن منبع',
  'builder.previewMore': '{count} ردیف دیگر',
  ...
  'pages.openTabs': 'صفحات باز',
  'pages.closeTab': 'بستن زبانه',
  ...
  'search.kind.destination': 'مکان',
  'search.kind.asset': 'دارایی',
  'search.uploadAssets': 'بارگذاری دارایی‌ها',
  'search.kind.import': "درون‌ریزی",
  'search.importLink': "این پیوند را به داده تبدیل کن",
  'mail.title': 'Mail',
  ...
  'entry.navOrganization': 'سازمان',
  'entry.navDock': 'میانبرهای نوار کناری',
  'entry.navDockHint': 'برای باز کردن کلیک کنید. برای تغییر ترتیب بکشید. برای حذف راست‌کلیک کنید.',
  'entry.navDockRemove': 'حذف از نوار کناری',
  'entry.navDockEdit': 'افزودن یا حذف میانبرها',
  'entry.navDockEmptyAdd': 'همه میانبرها در نوار کناری هستند',
  'entry.navDockPlaces': 'مکان‌ها',
  'entry.navDockApps': 'اپ‌ها',
  'entry.navDockRemoving': 'برای حذف رها کنید',
  'entry.navPin': 'افزودن به نوار کناری',
  'account.menuAria': 'حساب',
  'account.signedInAs': 'وارد شده',
  'account.signOut': 'خروج',
  'account.thisComputer': 'این رایانه',
  'account.signInTitle': 'ورود به Plyxl',
  'account.signInLead': 'وارد شوید یا حساب جدیدی بسازید تا ادامه دهید.',
  ...
  'org.noOrganization': 'بدون سازمان',
  'org.switcherLabel': 'سازمان‌های شما',
  'org.memberCount': '{count} عضو',
  'org.newOrgName': 'نام سازمان جدید',
  'org.create': 'ایجاد',
  'org.createOrganization': 'سازمان جدید',
  'org.manage': 'مدیریت سازمان',
  'org.membersTitle': 'افراد',
  'org.membersSubtitle': 'همه کسانی که پروژه‌ها، برنامه‌ها و داده‌های این سازمان را می‌بینند.',
  'org.inviteTitle': 'دعوت کردن',
  'org.inviteHint': 'با ایمیل یا نام کاربری دعوت کنید، یا پیوندی بسازید که هر کسی بتواند باز کند.',
  'org.invitePlaceholder': 'name@company.com یا نام کاربری',
  'org.sendInvite': 'ارسال دعوت',
  'org.inviteNeedTarget': 'ایمیل یا نام کاربری وارد کنید، یا به‌جای آن یک پیوند بسازید.',
  'org.inviteTarget': 'به',
  'org.inviteSentTo': 'این پیوند را برای {target} بفرستید. فقط یک‌بار نمایش داده می‌شود و بعداً بازیابی نمی‌شود.',
  'org.inviteEmailed': 'Invite emailed to {target} via Gmail. The link is shown once and cannot be retrieved later.',
  'org.createInvite': 'ساخت لینک دعوت',
  'org.copyLink': 'کپی لینک',
  'org.joinCode': 'Join code',
  'org.copyCode': 'Copy code',
  'org.copied': 'کپی شد',
  'org.dismiss': 'بستن',
  'org.linkShownOnce': 'این لینک فقط یک بار نمایش داده می‌شود. همین حالا کپی کنید — بعداً قابل بازیابی نیست.',
  'org.members': 'اعضا',
  'org.person': 'شخص',
  ...
  'org.remove': 'حذف',
  'org.invites': 'دعوت‌ها',
  'org.kind.link': 'هر کس با پیوند',
  'org.kind.email': 'ایمیل',
  'org.kind.username': 'نام کاربری',
  'org.pendingInvites': 'دعوت‌های شما',
  'org.acceptInvite': 'پیوستن',
  ...
  'org.uses': 'استفاده‌ها',
  'org.revoked': 'باطل‌شده',
  'org.revoke': 'باطل کردن',
  'org.settings': 'تنظیمات',
  'org.organizationName': 'نام سازمان',
  'org.rename': 'تغییر نام',
  'org.renameOrganization': 'تغییر نام سازمان',
  'org.role.owner': 'مالک',
  'org.role.admin': 'مدیر',
  'org.role.member': 'عضو',
  ...
  'apps.title': 'برنامه‌ها',
  'apps.subtitle': 'ابزارهایی که تیم شما منتشر کرده است. در پروژه می‌سازید؛ برنامه چیزی است که همکارانتان باز می‌کنند.',
  'apps.empty': 'هنوز برنامه‌ای نیست. ابزاری را از یک پروژه منتشر کنید.',
  'apps.share': 'اشتراک‌گذاری',
  'apps.archive': 'بایگانی',
  'apps.dismiss': 'بستن',
  'apps.visibility': 'قابلیت دیده شدن',
  'apps.visibility.private': 'فقط من',
  'apps.visibility.org': 'همه در سازمان',
  'apps.visibility.link': 'هر کسی که لینک را دارد',
  'apps.shareWarning': 'این لینک یک بار نمایش داده می‌شود. هر کس آن را داشته باشد می‌تواند این برنامه را باز کند.',
  'apps.byline': 'از {name}',
  'apps.bylineUnknown': 'منتشر شد',
  'apps.neverOpened': 'هرگز باز نشده',
  'apps.minutesAgo': '{count} دقیقه پیش',
  'apps.hoursAgo': '{count} ساعت پیش',
  'apps.daysAgo': '{count} روز پیش',
  'join.eyebrow': 'برای پیوستن دعوت شده‌اید',
  'join.roleLine': 'به‌عنوان {role} می‌پیوندید.',
  'join.accept': 'پیوستن به سازمان',
  'join.loading': 'در حال بررسی دعوت…',
  'join.joining': 'در حال پیوستن…',
  'join.joined': 'انجام شد. در حال انتقال…',
  'join.cannotJoin': 'این دعوت قابل استفاده نیست',
  'join.expired': 'این لینک دعوت منقضی شده است.',
  'join.revoked': 'این لینک دعوت باطل شده است.',
  'join.exhausted': 'این لینک دعوت به حد مجاز رسیده است.',
  'join.invalid': 'این لینک دعوت معتبر نیست.',
  'join.wrongRecipient': 'این دعوت برای شخص دیگری فرستاده شده. با حساب همان فرد وارد شوید.',
  'join.restrictedHint': 'این دعوت مخصوص یک فرد است. برای پیوستن با حساب او وارد شوید.',
  'join.goHome': 'رفتن به خانه',
  'database.title': 'پایگاه داده شرکت',
  'database.subtitle': 'جدول‌های دائمی و ساخت‌یافته‌ای که هر ابزار بر آن‌ها بنا می‌شود. ابزارها یک‌بارمصرف‌اند — این داده‌ها نه.',
  'database.workspace': 'فضای کاری',
  'database.newWorkspaceName': 'نام فضای کاری جدید',
  'database.create': 'ایجاد',
  'database.tables': 'جدول‌ها',
  'database.noTables': 'هنوز جدولی وجود ندارد. اینجا یکی بسازید یا از عامل بخواهید ابزاری بسازد که به آن نیاز دارد.',
  'database.newTable': 'جدول جدید',
  'database.tableName': 'نام جدول (snake_case)',
  'database.fieldName': 'نام فیلد',
  'database.fieldType': 'نوع',
  'database.required': 'الزامی',
  'database.unique': 'یکتا',
  'database.addField': 'افزودن فیلد',
  'database.createTable': 'ایجاد جدول',
  'database.records': 'رکوردها',
  'database.noRecords': 'هنوز رکوردی وجود ندارد.',
  'database.addRecord': 'افزودن رکورد',
  'database.deleted': 'حذف‌شده',
  'database.delete': 'حذف',
  'database.restore': 'بازیابی',
  'database.history': 'تاریخچه',
  'database.audit': 'گزارش ممیزی',
  'database.revision': 'بازبینی',
  'database.showDeleted': 'نمایش حذف‌شده‌ها',
  'database.loadError': 'بارگیری پایگاه داده ممکن نشد.',
  'database.saveError': 'ذخیره ناموفق بود',
  ...
  'homeHero.chip.createPluginHint': 'یک افزونه قابل استفاده مجدد Substrate بسازید و آن را به افزونه‌های من اضافه کنید.',
  ...
  'handoff.amrWebsite': 'باز کردن وب‌سایت Substrate Cloud',
  ...
  'handoff.promptIntro': 'ادامه از این پوشه محلی پروژه Substrate:',
  ...
  'pluginsHome.title': 'ساخته‌شده توسط دیگران در {org}',
  'pluginsHome.titleFallback': 'ساخته‌شده توسط دیگران',
  'pluginsHome.subtitle': 'گردش‌کارهای آماده Substrate که همراه این runtime ارائه شده‌اند. یکی را برای بارگذاری یک پرامپت شروع انتخاب کنید، یا برای موارد بیشتر در رجیستری بگردید.',
  ...
  'pluginsHome.emptyCatalog': 'کاتالوگ خالی است. پلاگین‌های همراه با Substrate ارائه می‌شوند و باید به‌صورت خودکار اینجا نمایش داده شوند — اگر این مشکل ادامه داشت، daemon را مجدداً راه‌اندازی کنید.',
  ...
  'pluginCard.contributeAria': 'مشارکت {title} در Substrate',
  'pluginCard.contributeTitle': 'مشارکت افزونه در Substrate با یک PR',
  ...
  'integrations.lede': 'سیستم‌های خارجی را متصل کنید، ابزارهای MCP را به حلقه Agent خود بیاورید و از Substrate در سایر IDEها، اسکریپت‌ها و خودکارسازی‌ها استفاده کنید.',
  ...
  'integrations.advanced': 'پیشرفته',
  'integrations.advancedAria': 'گزینه‌های پیشرفته Connect',
  ...
  'mcpClient.daemonError': 'دسترسی به daemon محلی ممکن نشد. مطمئن شوید Substrate در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'mcpClient.saveFailed': 'ذخیره ناموفق بود. بررسی کنید که daemon در حال اجرا باشد و دوباره تلاش کنید.',
  'useEverywhere.modalAria': 'استفاده از Substrate در همه‌جا',
  'useEverywhere.modalTitle': 'استفاده از Substrate در همه‌جا',
  'useEverywhere.modalSubtitle': 'Substrate را در هر IDE، Agent یا اسکریپتی بگنجانید — CLI، HTTP، MCP و Skills. از «Copy guide for an agent» استفاده کنید و آن را در Claude Code، Codex، Cursor، openclaw یا hermes جای‌گذاری کنید تا همه‌چیز راه‌اندازی شود.',
  ...
  'useEverywhere.section.overview.heading': 'Substrate هر جا که Agent شما کار کند، کار می‌کند',
  'useEverywhere.section.overview.intro': 'Substrate چیزی فراتر از یک پنجره است — یک daemon محلیِ دارای دسترسی ویژه (`od`) به‌علاوه یک رجیستری از Skills + Design-Systems + Atoms است. به‌محض اینکه روی دستگاه شما در حال اجرا باشد، هر code agent (Claude Code، Codex، Cursor، OpenCode/openclaw، Hermes، یا اسکریپت خودتان) می‌تواند تولیدها را هدایت کند، پروژه‌ها را بررسی کند و از طریق چهار سطح قابل‌تعویض، آثار طراحی تولید کند.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` برای اسکریپت‌های headless، CI و اتوماسیون shell.',
  'useEverywhere.section.overview.bullet2': 'سرور MCP — Substrate را به‌عنوان یک سرور Model Context Protocol سیم‌کشی می‌کند تا هر Agent سازگار با MCP بتواند skillها را فهرست کند، سناریوها را اجرا کند و آثار را بخواند.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — بسته‌های آمادهٔ `SKILL.md` (سازگار با Claude) که هر Agent موجود در PATH شما می‌تواند بدون نیاز به Substrate اصلاً فراخوانی‌شان کند.',
  ...
  'useEverywhere.section.cli.heading': 'کنترل Substrate از هر shell',
  ...
  'useEverywhere.section.mcp.heading': 'در معرض قرار دادن Substrate به‌عنوان یک سرور MCP برای هر Agent کدنویسی',
  'useEverywhere.section.mcp.intro': 'Substrate با یک سرور Model Context Protocol (`od mcp`) ارائه می‌شود که به هر کلاینت سازگار با MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اجازه می‌دهد ابزارهای Substrate را کشف کند (فهرست‌کردن skillها، رندر پیش‌نمایش‌ها، تولید رسانه، اجرای پلاگین‌ها) بدون نیاز به اجرای دستی در shell. این daemon برای هر کلاینت اصلی یک قطعهٔ نصب آمادهٔ جای‌گذاری را از طریق `GET /api/mcp/install-info` منتشر می‌کند.',
  ...
  'useEverywhere.section.mcp.footer': 'در اپلیکیشن Substrate، به Settings ← Integrations بروید تا یک دستور نصب مخصوص کلاینت (Cursor، Claude Code، Antigravity، VS Code) را کپی کنید، به‌جای ویرایش دستی JSON.',
  ...
  'useEverywhere.section.skills.heading': 'Skillهای آمادهٔ استفاده برای هر Agent — حتی بدون اجرای Substrate',
  'useEverywhere.section.skills.intro': 'یک Skill دایرکتوری‌ای است با یک `SKILL.md` سازگار با Claude (فرانت‌متر YAML + بدنه). Substrate این فرمت را با namespace به نام `od:` گسترش می‌دهد (`mode`، `preview`، `design_system`، `inputs`، …) تا همان اثر هم درون Substrate و هم توسط یک Agent معمولی مانند Claude Code، Codex، openclaw یا hermes قابل‌استفاده باشد. کشف از یک زنجیرهٔ اولویت پیروی می‌کند تا پروژه‌ها بتوانند skillهای خود را بازنویسی کنند.',
  ...
  'useEverywhere.section.skills.snippet1': 'حداقل SKILL.md (front matter سازگار با Claude + افزوده‌های Substrate)',
  ...
  'entry.githubStarAria': 'به Substrate در GitHub ستاره بدهید',
  ...
  'newproj.locationDefault': 'پروژه‌های Substrate',
  ...
  'newproj.visibilityLabel': 'نمایش',
  'newproj.visibilityPrivate': 'خصوصی',
  'newproj.visibilityPrivateDetail': 'فقط افراد سازمان شما می‌توانند از آن استفاده کنند.',
  'newproj.visibilityPublic': 'عمومی',
  'newproj.visibilityPublicDetail': 'یک لینک عمومی وب می‌گیرد که هر کسی بدون حساب می‌تواند باز کند.',
  'newproj.visibilityRequired': 'برای ادامه خصوصی یا عمومی را انتخاب کنید.',
  ...
  'avatar.amrConsole': 'حساب Substrate Cloud',
  ...
  'socialShare.openDesignSection': 'اشتراک‌گذاری Substrate',
  'socialShare.openDesignTitle': 'Substrate در GitHub',
  'socialShare.openDesignText': 'Substrate یک فضای کاری متن‌باز برای ساخت، ویرایش، استقرار و تحویل آرتیفکت‌های طراحی است.',
  ...
  'socialShare.projectText': 'ساخته‌شده با Substrate: {title}. آرتیفکت مستقرشده را ببینید و به مخزن ستاره بدهید: {repo}',
  'socialShare.projectCopyText': 'ساخته‌شده با Substrate: {title}\n{url}\nمخزن Substrate: {repo}',
  ...
  'brandEnrichment.body': "Substrate یک استخراج عمیق تر را در پس زمینه اجرا می کند، skills مناسب design system را خودکار اعمال می کند و همین سیستم را درجا به روز می کند. این کار ممکن است 10 تا 20 دقیقه طول بکشد؛ می توانید به کارتان ادامه دهید.",
  ...
  'chat.activeFilePlaceholder': 'از Substrate بخواهید {file} را تغییر دهد...',
  ...
  'chat.mode.design.solves': 'وقتی می خواهید Substrate فایل بسازد، workspace را به روز کند یا brief را به خروجی های چندرسانه ای قابل تحویل تبدیل کند استفاده کنید.',
  ...
  'chat.mentionTabPeople': 'افراد',
  'chat.mentionNoResults': 'هیچ نتیجه‌ای برای «{query}» یافت نشد.',
  'chat.mentionSearchPrompt': 'افراد، فایل‌های طراحی، تب‌ها، پلاگین‌ها، مهارت‌ها، سرورهای MCP و کانکتورها را جستجو کنید.',
  ...
  'chat.mentionSectionPeople': 'افراد',
  ...
  'preview.shareTextDefault': 'قالب Substrate: {title}',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Substrate در حال اجراست و دوباره تلاش کنید.',
  ...
  'designFiles.usefulInfoTip5': 'ایده‌ای ندارید؟ قالب‌های ساخته‌شده توسط دیگران در صفحهٔ اصلی را امتحان کنید.',
  'designFiles.usefulInfoTip6': 'سؤال یا پیشنهادی دارید؟ به Discord ما بپیوندید.',
  'designFiles.usefulInfoTip7': 'از Substrate راضی هستید؟ در GitHub به ما ستاره بدهید.',
  ...
  'designFiles.usefulInfoTip18': 'برای آموزش‌ها و دموها، Substrate را در YouTube دنبال کنید.',
  'designFiles.usefulInfoTip19': 'برای اخبار محصول، Substrate را در LinkedIn دنبال کنید.',
  'designFiles.usefulInfoTip20': 'برای نکته‌ها و الهام، Substrate را در Xiaohongshu دنبال کنید.',
  ...
  'assistant.shareToOpenDesign': 'اشتراک‌گذاری در Substrate',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Substrate — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه Substrate ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'settings.projectLocationsDescription': 'پایه‌های کاری اضافه کنید که می‌توانند چند پوشهٔ پروژهٔ Substrate را در خود داشته باشند. پروژه‌های جدید به‌صورت یک پوشه داخل پایهٔ انتخاب‌شده ذخیره می‌شوند.',
  ...
  'settings.customInstructionsHint': 'دستورالعمل‌های ثابتی که Substrate باید در هر گفت‌وگو دنبال کند. حقایق، ترجیحات و زمینهٔ پروژه را به‌عنوان حافظه ذخیره کنید.',
  ...
  'settings.memoryStarterProjectDesc': 'Substrate v0.5 — ویرایشگر طراحی مبتنی بر گفتگو',
  ...
  'updater.activeRunsTitle': 'Substrate هنوز در حال کار است',
  'updater.activeRunsBody': '{count} کار فعال هنوز در حال اجراست. راه‌اندازی مجدد اکنون آن‌ها را متوقف می‌کند.',
  'updater.activeRunsUnknownBody': 'Substrate نتوانست بررسی کند که آیا کاری در حال اجراست. راه‌اندازی مجدد ممکن است کار فعال را متوقف کند.',
  'updater.availableBody': 'Substrate {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. Substrate در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن Substrate',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما Substrate بسته نشد. پیش از جایگزینی برنامه، Substrate را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. Substrate بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'Substrate {version} آماده است. Substrate بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.reinstallLearnMore': 'اطلاعات بیشتر',
  'updater.reinstallReadyGeneric': 'این به‌روزرسانی به نصب مجدد کامل نیاز دارد. Substrate بسته می‌شود و نصب‌کننده باز خواهد شد.',
  'updater.reinstallReadyVersion': 'Substrate {version} به نصب مجدد کامل نیاز دارد. Substrate بسته می‌شود و نصب‌کننده باز خواهد شد.',
  ...
  'dsManager.createBody': 'برند، محصول، کد، دارایی‌ها و مراجع طراحی خود را به Substrate بیاموزید.',
  ...
  'settings.customInstructionsDesc': 'دستورالعمل‌های ثابتی که Substrate در هر گفت‌وگو از آن‌ها پیروی می‌کند. این‌ها حافظه ذخیره‌شده نیستند؛ برای واقعیت‌ها، ترجیحات و بافت پروژه از حافظه استفاده کنید.',
  ...
  'onboarding.buildBody': 'Substrate برند شما را به یک سیستم طراحی قابل‌استفاده‌ی مجدد تبدیل می‌کند و هر چیزی را که می‌سازید هماهنگ و وفادار به برند نگه می‌دارد.',
  ...
  'publish.title': 'انتشار در وب',
  'publish.subtitle': 'هر کسی که پیوند را داشته باشد می‌تواند آن را در مرورگر باز کند. نیازی به نصب نیست.',
  'publish.notConfigured': 'میزبانی روی این سرویس پیکربندی نشده است.',
  'publish.signInRequired': 'برای انتشار در وب وارد شوید.',
  'publish.addressLabel': 'نشانی وب',
  'publish.slugHint': 'حروف، اعداد و خط تیره.',
  'publish.slugChecking': 'در حال بررسی در دسترس بودن…',
  'publish.slugAvailable': 'در دسترس',
  'publish.visibilityLabel': 'چه کسی می‌تواند آن را باز کند',
  'publish.visibilityPublic': 'همه',
  'publish.visibilityPublicDetail': 'عمومی در وب',
  'publish.visibilityOrg': 'سازمان من',
  'publish.visibilityOrgDetail': 'اعضا باید وارد شوند',
  'publish.visibilityOrgUnavailable': 'به یک سازمان نیاز دارد',
  'publish.progressPreparing': 'در حال آماده‌سازی فایل‌ها…',
  'publish.versionsLabel': 'نسخه‌ها',
  'publish.versionFileCount': '{count} فایل',
  'publish.versionLive': 'زنده',
  'publish.rollback': 'بازگردانی',
  'publish.unpublish': 'لغو انتشار',
  'publish.close': 'بستن',
  'publish.publish': 'انتشار',
  'publish.republish': 'انتشار مجدد',
  'publish.publishing': 'در حال انتشار…',
  'publish.copy': 'کپی',
  'publish.copied': 'کپی شد',
  'publish.menuItem': 'انتشار فوری',
  'publish.menuItemDetail': 'به حساب یا کلید API نیازی نیست',
};
