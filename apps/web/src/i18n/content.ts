...
const DE_SKILL_COPY: Record<string, LocalizedSkillCopy> = {
  ...
  'agent-browser': {
    examplePrompt:
      'Verifizieren Sie die lokale Substrate-Vorschau mit agent-browser: starten oder verbinden Sie CDP Chrome, öffnen Sie http://127.0.0.1:17573/, melden Sie Titel, URL, sichtbare Texte und speichern Sie einen Screenshot.',
    description:
      'Browser-Automation für lokale Substrate-Preview-Validierung. Verbindet sich mit einem geprüften CDP-Chrome-Endpunkt, liest gerenderten Seitenzustand, kann bei Bedarf klicken/tippen und speichert einen Screenshot.',
  },
  'blog-post': {
    examplePrompt:
  ...
  'open-design-landing': {
    examplePrompt:
      'Entwerfen Sie die Substrate-Marketing-Landingpage im Atelier-Zero- / Monocle-Stil — warme Papierleinwand, surreale Plaster-und-Architektur-Collage, übergroße gemischte Italic-Serif-Display-Type, römische Ziffern als Sektionsmarker und ein einziger Korallenakzent.',
  },
  'open-design-landing-deck': {
    examplePrompt:
      'Erstellen Sie das Substrate-Pitch-Deck im Atelier-Zero-Stil — Cover mit Hero-Plate, römische Sektions-Trenner, Stats-Slide (31 Skills · 72 Systeme · 12 CLIs), Kundenzitat, CTA und Mega-Italic-Serif-End-Card. Horizontal-Swipe-Pagination wie eine Print-Magazine.',
    description:
