...
function describeExtractionFailure(record: MemoryExtractionRecord): FriendlyExtractionFailure | null {
  ...
  const source =
    record.kind === 'connector'
      ? 'Connected apps were read, but Substrate could not turn that context into memory.'
      : 'Substrate could not run memory extraction for this chat.';
    ...
    try {
      ...
      if (friendlyFailure) {
        ...
        setConnectorError(
          ...
          ?? 'No memory suggestions found. Substrate could not read useful content from the selected app yet.',
        );
      } else {
        setConnectorStatus(
          ...
          <div className="memory-connector-workbench">
            <div className="memory-connector-picker-head">
              <div>
                ...
                <p className="hint">
                  Select connected apps first. Substrate only scans the apps you choose.
                </p>
              </div>
              <span className="memory-source-badge">
