...
export function composePagesWikiPrompt(input: {
  ...
  const lines = [
    ...
    '3. Fill pages with headings, lists, to-dos, toggles, callouts, quotes, code, dividers, bookmarks, live embeds, and inline tables. Creating a child page automatically embeds it on the parent (a page-in-a-page) unless you pass `linkOnParent: false`.',
