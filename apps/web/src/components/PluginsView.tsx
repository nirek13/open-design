...
const PLUGIN_SHARE_DETAILS: Record<PluginShareAction, {
  ...
  'publish-github': {
    ...
    fallbackDescription:
      'Creates a public GitHub repository for this local Substrate plugin.',
    confirmLabel: 'Start publishing',
    steps: [
      'Create a new Substrate project for the publish workflow.',
  ...
  'contribute-open-design': {
    eyebrow: 'Substrate pull request',
    fallbackTitle: 'Contribute Plugin to Substrate',
    fallbackDescription:
      'Opens a pull request that adds this plugin to the Substrate community catalog.',
    confirmLabel: 'Start contribution',
    steps: [
      'Create a new Substrate project for the contribution workflow.',
      'Copy this plugin into that project as isolated source context.',
          ...
          {installedRecord ? (
            <section className="plugin-details-modal__section">
              ...
              <p className="plugin-details-modal__section-hint">
                This official catalog entry is bundled with Substrate and is ready to use.
              </p>
            </section>
          ) : (
            <section className="plugin-details-modal__section">
