// Trigger prompt for the post-completion "Share to Substrate" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an Substrate plugin so I can install it into My plugins and open a PR to the Substrate community catalog.',
  '',
  ...
  '- **Substrate PR** — opens a draft PR against `nexu-io/open-design` for the community catalog.',
  '',
