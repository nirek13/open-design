...
interface Props {
  ...
  /** Substrate Cloud profile from the blocking snapshot; picks the console origin. */
  profile: string | null;
...
// HARD pre-run blocker for Substrate Cloud tasks: the run cannot possibly
...
//
//   signed_out — Substrate Cloud selected but no account session. The CTA
...
export function AmrBalanceDialog({
  ...
  const openWallet = () => {
    ...
    // Same attribution handshake as the other Substrate Cloud handoffs
