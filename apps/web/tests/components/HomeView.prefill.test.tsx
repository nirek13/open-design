...
const AUTHORING_PLUGIN = {
  ...
  manifest: {
    ...
    od: {
      ...
      useCase: { query: 'Create an Substrate plugin for {{pluginGoal}}.' },
      inputs: [
        {
          name: 'pluginGoal',
          type: 'string',
...
const LIVE_ARTIFACT_PLUGIN = {
  ...
  manifest: {
    ...
    title: 'Live Artifact',
    description: 'Create refreshable, auditable Substrate artifacts.',
    od: {
      kind: 'scenario',
      taskKind: 'new-generation',
      mode: 'prototype',
      scenario: 'live',
      useCase: {
        query: 'Create refreshable, auditable Substrate artifacts backed by connector or local data.',
      },
      context: {
...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'Substrate plugin',
  audience: 'Substrate plugin authors',
  topic: 'packaging a reusable workflow as an Substrate plugin',
};
