...
describe('HandoffButton zero-editors fallback', () => {
  ...
  it('copies a framework-specific CLI handoff prompt with the local project path', async () => {
    ...
    const amrWebsiteLink = screen.getByRole('link', { name: /打开 Substrate Cloud 官网/ }) as HTMLAnchorElement;
    ...
    expect(screen.getByTestId('handoff-cli-item-amr').textContent).toContain('Substrate');
