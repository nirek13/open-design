...
describe("@open-design/release", () => {
  ...
  it("centralizes release identity and namespace derivation", () => {
    expect(releaseChannelDescriptor("prerelease").productName).toBe("Substrate Prerelease");
    expect(releaseChannelDescriptor("betas").productName).toBe("Substrate Betas");
